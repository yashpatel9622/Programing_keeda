...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Multiple Inheritance</p></b></i></center></h1></div>				
					<ul>
					<b>Multiple Inheritance:</b>it refers to the concept of one class extending more than one base class.
					<br>					
					<b>Example:</b>
					class A{<br>
					}<br>
			...
			<div class="but">
				...
				<a href="java_single.php" class="button next">prev &raquo;</a>
				<a href="java_multil.php" class="button next">next &raquo;</a>
				</div>
</div>
