	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Reverse number using array</h1>
				<div class="ReverseArrayNumber">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	void main()
	{
		...
		for(i=n-1;i>=0;i--)
			printf("%d",array[i]);
				...
				<br>
				<br>
				<img src="ReverseArrayOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Reverse1.php" class="button prev">&laquo;prev</a>
					<a href="Palindrome1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
