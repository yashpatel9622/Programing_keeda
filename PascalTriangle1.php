	...
	long factorial(int n)
	{
		...
		for(c=1;c<=n;c++)
			...
			return(result);
				...
				<br>
				<br>
				<img src="PascalTriangleOP.png" alt="c programming label"> 
				<div class="but">
					<a href="FloydsTriangle1.php" class="button prev">&laquo;prev</a>
					<a href="DecimalToBinaryBit1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
