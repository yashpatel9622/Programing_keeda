	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>bsearch</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">void *bsearch(const void *key,const void *base,size_t num,size_t size,int (*compare)(const void *, const void *));</div>
				<br>
	<h2>Binary search in array</h2>
				<br>
				<div class="header2">
