...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>setjmp</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< setjmp.h></h2></div>
				<div class="header1">int setjmp(jmp_buf env);</div>
				<br>
	<h2>Save calling environment for long jump</h2>
				<br>
				<div class="header2">
	This function with functional from takes its argument, env fills its content with information about the environment state in that point in the code to be able to restore that state in a later call to longjmp. 
				<br>
				<br>
	<h3>Parameters</h3>
	env
	...
	Object of type jmp_buf where the environment information is stored.
				...
				<br>
	<h3>Return Value</h3>
	This macro may return more than once. A first time, on its direct invocation, in this case it always return zero.	
				<br>
