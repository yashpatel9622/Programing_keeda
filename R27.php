	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Exception handling keywords </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Exception handling keywords<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>

<p>Exceptions are events that occur during the execution of programs that </br>disrupt the normal flow of instructions (e.g. divide by zero, array access out of bound, etc.). </br>In Java, an exception is an object that wraps an error event that occurred within </br>a method and contains: Information about the error including its type.
...
<br>
<br>
<h3>you can used five keywords for handling a Exceptions</h3>
<i> try</i>
<i>catch</i>
<i>throw</i>
<i>throws</i>
...
To throw an exception, use the keyword throw. Any checked/unchecked exception and error can be thrown.
	...
	if (n == -1)
	  ...
	  <br>
	  <br>
<h3>The try/catch/finally Keywords</h3>
<p>
Thrown exceptions are handled by a Java try, catch, finally block. </br>The Java interpreter looks for code to handle the exception, first looking in the enclosed block</br> of code, and then propagating up the call stack to main( ) if necessary.</br> If the exception is not handled, the program exits and a stack trace is printed.
...
<h3>The try Block</h3>
<p>
The try block contains code that may throw exceptions. All checked exceptions that</br> may be thrown must have a catch block to handle the exception. If no exceptions are thrown, </br>the try block terminates normally. ...
</p>
