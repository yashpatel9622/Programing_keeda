...
<div id="right-section">
				...
				<div class="holder2">
					...
					<ul>
					<b>Array:</b> It is a collection of homogeneous types of elements.any elements from array can be access by using index.</li>
	                 <br>
					*Types:
					<br>
					1.one dimentional array:
					<br>
					  Syntax: data_types arr_name[];
					  <br>
					  eg.int num[];
					<br>
					2.Two dimentional Array:it represents table or matrix that consist of two subscript.first subscript represents a row & other one represents the colum within that row.
					<br>
			...
			<div class="but">
						...
						<a href="java_key.php" class="button next">prev &raquo;</a>
				<a href="java_string.php" class="button next">next &raquo;</a>
				</div>
</div>
</div>
<div id="footer">
