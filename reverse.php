...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Check Original Equal Reverse or Not</h1>
				<div class="Structure">
					<pre>
						<code class="ccode" >
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="reverse.jpg" alt="c programming label"> 
				<div class="but">
					<a href="leap.php" class="button prev">&laquo;prev</a>
					<a href="asmd.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
