...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Print Integer</h1></pre>
				<div class="printinteger">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	int main()
	{
		...
		scanf("%d",&a);
		printf("Integer that you have entered 
		is %d \n",a);
		return 0;
	}
						</code>
				...
				<br>
				<br>
				<img src="IntegerOP.png" alt="c programming label"> 
				<div class="but">
					<a href="ma1.php" class="button prev">&laquo;prev</a>
					<a href="addition1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
