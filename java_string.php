...
<div id="right-section">
				...
				<div class="holder2">
					...
					<ul>
					<b>String:</b>in java, String is basically an object that represents sequence of char values.the java platform provides the string class to create and manipulate Strings.
					<br><b>Creating String:</b><br>
					<b>1.</b>The most direct way to create a string is to write:<br>
					String str1="hello java";<br>
					<b>2.</b>Using another String object:<br>
					String str2=new String(str1);<br>
					<b>3.</b>using new keyword<br>
					String str3=new String("java");<br>
					<b>4.</b>Using + Operator(concatination)<br>
			...
			<div class="but">
				...
				<a href="java_array.php" class="button next">prev &raquo;</a>
				<a href="java_inherit.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
