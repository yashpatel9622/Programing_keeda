...
<body>
	...
	void  main()
	{
		...
		octal);
				...
				<br>
				<br>
				<img src="DecimalToOctalOP.png" alt="c programming label"> 
				<div class="but">
					<a href="DecimalToBinary1.php" class="button prev">&laquo;prev</a>
					<a href="BinaryToDecimal1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
