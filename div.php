...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>div</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">div_t div(int numerator,int denominator);</div>
				<br>
	...
	Denominator.
				...
				<br>
	<h3>Return Value</h3>
	The result is returned by value in a div_t structure defined in <stdlib.h>, which has two members:
				<br>
	int quot; int rem; 
				</div>
