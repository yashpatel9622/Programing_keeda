	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Interface</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Interface<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>An interface in java is a blueprint of a class. It has static constants </br>and abstract methods. The interface in java is a mechanism</br> to achieve abstraction. There can be only abstract methods in the java interface </br>not method body. It is used to achieve abstraction and multiple inheritance in Java.
</p>
<br>
<br>
<h3>Why use Java interface?
</h3>
<p>
...
<br>
<br>
<h3>Implementinginterface
</h3>
<p>
An implementation of an interface is a Java program that references the interface using the implements keyword.</br> The program is required to provide method logic for all non-default methods. Optionally, </br>the program can provide an implementation of a default method defined in the interface.
</p>
<br>
<br>
<h3>extending interface</h3>
<p>
A Java class can only extend one parent class. Multiple inheritance is not allowed.</br> Interfaces are not classes, however, and an interface can extend more than one parent </br>interface. The extends keyword is used once, and the parent interfaces are declared </br>in a comma-separated list.
