...
#left-panel{width:22%;height:2230px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2210px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<p>The if statement may itself contain another if statement is called as nested if statement.</p>
				<br>
...
<div class="but">
				<a href="cpp_ifelse.php" class="button prev">&laquo;prev</a>
				<a href="cpp_elseif.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
