	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<ul>
				<li>Pointers in C language is a variable that stores/points the address of another variable. A Pointer in C is used to allocate memory dynamically i.e. at run time. The pointer variable might be belonging to any of the data type such as int, float, char, double, short etc. </li>
				<br>
				...
				<h3 style=color:green>Key Points to remember about Pointers:</h3>
<div class="holder3">
...
int main()
{
   ...
   return 0;
				...
				<div class="but">
				<a href="c_string.php" class="button prev">&laquo;prev</a>
				<a href="c_structure.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
