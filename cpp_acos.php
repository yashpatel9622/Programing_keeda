...
<i>Description</i>
<p>
Computer arc cosine: return the principle value of the X cosine. </br>Expressed in radiance .in trignometrics ,arc  cosine is the reverse operation 
of cosine. Additional overloads are provided in this header<camath> for the integer types:</br>These overloads effectively cast X to a double before calculations .
this function also overloaded in <complex>and <valarry>
</p>
<i>prototype</i>
<b> double  acos (double X); float acos (float X); long acos (long X).</b>
<i>parameters</i>
<p>
parameters X value whose arc cosine is computed, </br>in the interval[-1,+1].if the argument is out of interval,a domain error occurs.
</P>
<i>return valus</i>
<p>
principal arc cosine of x, in the interval[0,pi]radiance value.
</p>
