...
<body>
  ...
  <h1 style=color:green;>Quiz : The Pointers of C</h1>
  <br>
  <br>
  <ol class="quiz">
 <div class="q1">
    <li>
  <b>Que 1:Which of the following is the proper declaration of a pointer?</b>
      <ul class="answers">
        <li><input type="radio" name="question-1" id="answer-1-1"><label for="answer-1-1">A. int x;</label> </li>
        <li><input type="radio" name="question-1" id="answer-1-2"><label for="answer-1-2">B. int &x;</label></li>
        <li><input type="radio" name="question-1" id="answer-1-3"><label for="answer-1-3">C. ptr x;</label></li>
        <li><input type="radio" name="question-1" id="answer-1-4"><label for="answer-1-4">D. 4int *x;</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: Which of the following gives the memory address of integer variable a?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. *a;</label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B. a;</label></li>
		<li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. &a;</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. address(a);</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b>Que 3:  Which of the following gives the memory address of a variable pointed to by pointer a?</b>
      <ul class="answers">
        <li><input type="radio" name="question-3" id="answer-3-1"><label for="answer-3-1">A. *a;</label></li>
        <li><input type="radio" name="question-3" id="answer-3-2"><label for="answer-3-2">B. a;</label></li>
        <li><input type="radio" name="question-3" id="answer-3-3"><label for="answer-3-3">C. &a;</label></li>
        <li><input type="radio" name="question-3" id="answer-3-4"><label for="answer-3-4">D. address(a);</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b> Que 4:  Which of the following gives the value stored at the address pointed to by pointer a?</b>
      <ul class="answers">
        <li><input type="radio" name="question-4" id="answer-4-1"><label for="answer-4-1">A. a;</label></li>
        <li><input type="radio" name="question-4" id="answer-4-2"><label for="answer-4-2">B. val(a);</label></li>
		 <li><input type="radio" name="question-4" id="answer-4-3"><label for="answer-4-3">C. *a;</label></li>
        <li><input type="radio" name="question-4" id="answer-4-4"><label for="answer-4-4">D. &a;</label></li>
	  </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 5: Which of the following is the proper keyword or function to allocate memory in C?</b>
      <ul class="answers">
        <li><input type="radio" name="question-5" id="answer-5-1"><label for="answer-5-1">A. new</label></li>
        <li><input type="radio" name="question-5" id="answer-5-2"><label for="answer-5-2">B. malloc</label></li>
        <li><input type="radio" name="question-5" id="answer-5-3"><label for="answer-5-3">C. create</label></li>
        <li><input type="radio" name="question-5" id="answer-5-4"><label for="answer-5-4">D. value</label></li>
	   </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: Which of the following is the proper keyword or function to deallocate memory?</b>
      <ul class="answers">
        <li><input type="radio" name="question-6" id="answer-6-1"><label for="answer-6-1">A. free</label></li>
        <li><input type="radio" name="question-6" id="answer-6-2"><label for="answer-6-2">B. delete</label></li>
        <li><input type="radio" name="question-6" id="answer-6-3"><label for="answer-6-3">C. clear</label></li>
        <li><input type="radio" name="question-6" id="answer-6-4"><label for="answer-6-4">D. remove</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
 	 <div class="q1">
    <li>
<b>Que 7: Are the expression *ptr++ and ++*ptr are same?</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8: Are the three declarations char **apple, char *apple[], and char apple[][] same?</b>
      <ul class="answers">
 ...
 int main()
{
    ...
    return 0;
      ...
      <ul class="answers">
        <li><input type="radio" name="question-9" id="answer-9-1"><label for="answer-9-1">A. ink</label></li>
        <li><input type="radio" name="question-9" id="answer-9-2"><label for="answer-9-2">B. ack</label></li>
        <li><input type="radio" name="question-9" id="answer-9-3"><label for="answer-9-3">C. ite</label></li>
        <li><input type="radio" name="question-9" id="answer-9-4"><label for="answer-9-4">D. let</label></li>
      </ul>
    </li>
	</div>
	<br>
  ...
  int main()
{
    ...
    return 0;
      ...
      <ul class="answers">
        <li><input type="radio" name="quiz-10" id="answer-10-1"><label for="answer-10-1">A. 30</label></li>
        <li><input type="radio" name="quiz-10" id="answer-10-2"><label for="answer-10-2">B. 27</label></li>
		<li><input type="radio" name="quiz-10" id="answer-10-3"><label for="answer-10-3">C. 9</label></li>
        <li><input type="radio" name="quiz-10" id="answer-10-4"><label for="answer-10-4">D. 63</label></li>
      </ul>
    </li>
	<div>
  </ol>
