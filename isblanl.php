	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<center style=font-size:25px;><h1 style=color:green;> isblank</h1></center>
			<br>
			<hr>
			<br>
...
check if character is alphabrtic: checks whether c is blank character. <br>
A blank character is a space character used to seperate "C" locale consider blank<br>
 a  character('\t') and the space character('').other locale may considered blank<br>
 a different selection of characters but they must also be space characters of <br>
 the standard ASCII character set,see the refernce for the <cctype> header.in C++<br>
 ,a locale-specified template versionof this function(isblank) <br>
 exist in header<locale> Compatibility notes: Standardrizer in C99(C++11).
...
<h2>prototype</h2>
<br>
<b style=font-size:25px;>int isblankint c);</b>
<br>
<h2>parameters</h2>
<br>
<p style=font-size:25px;>
