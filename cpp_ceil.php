...
<i>Description</i>
<p>
Round up value: Rounds X uoward. returing the samllest integralvalue that is not less than X.
 Additional overloads are provided in this header<camath> for </br>the integer types:These overloads effectively cast X to a double before calculations </br>.
</p>
<i>prototype</i>
<b> double  ceil (double X); float ceil float X); long ceil (long X).</b>
<i>parameters</i>
<p>
parameters X value to rounded up.</P>
<i>return valus</i>
<p>
The smallest integral value that is not lesstjan X.
</p>
