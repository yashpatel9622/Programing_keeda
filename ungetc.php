...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>ungetc</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int ungetc(int ch,FILE *stream);</div>
				<br>
	<h2>Unget character from stream</h2>
				<br>
				<div class="header2">
	The character ch is virtually put back into an input stream at the same position the last character was read and the internal file position indicator is decreased back to that previous position so that this character is returned by the next call to a reading operation on that stream.
				<br>
				<br>
	This ch character may or may not be the same character as the one last read from the stream in a previous operation. In both cases the value retrieved by the next reading operation on the stream is the one ungot by this function independently of the original character.	
				<br>
				<br>
	...
	A call to fseek, fsetpos or rewind on a stream will discard any characters previously put back into it with this function.
				<br>
				<br>
	If the argument passed for the ch parameter is EOF, the operation fails and the input stream remains unchanged.
				<br>
				<br>
	<h3>Parameters</h3>
	ch
