...
<div id="right-section">
				...
				<div class="holder2">
					...
					<ul>
					<b>Constructor:</b>Constructor is in java is a special type of method that is used to initialize the object.java constructor invokes at the time of object creation.
					<br><br><b>Rules of creating java constructor</b>
					<br>
					     <b>1.</b>constructor name must be same as its class name.
						 <br>
						 <b>2.</b>constructor must have no explicite return type.
						 <br><br>
						 <b>Types of constructor</b><br>
						 <b>1.</b>Default Constructor
						 <br>
						 <b>2.</b>Parameterized Constructor
						 <br><br>
						 <b>1.Default Constructor:</b>A constructor that have no parameter is known as default constructor.
						 <br>
						 <b>Syntax:</b>class name()
						 <br>
						 {
							 <br>
						 }
						 ...
						 <br>
						 <b>2.Parameterized Constructor:</b>A constructor that have parameter is known as parameterized constructor.
						 <br>
						 <b>Example:</b><br>
						 class Student{<br>
						 int id;<br>
						 String name;<br>
						 Student(int i,String n){<br>
						 id=i;<br>
						 name=n;<br>
						 }<br>
						 void display(){<br>
						 ...
						 public static void main(String args[]){<br>
						 Student s=new Student(111,"karan");<br>
						 Student s1=new Student(222,"aryan");<br>
						 s.display();<br>
						 s1.display();<br>
						 }<br>
						 }<br>
			...
			<div class="but">
				...
				<a href="java_for.php" class="button next">prev &raquo;</a>
				<a href="java_key.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
