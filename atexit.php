	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>atexit</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">int atexit(void (*func)(void));</div>
				<br>
	<h2>Set function to be executed on exit</h2>
				<br>
				<div class="header2">
	The function pointed by the func pointer argument is called when the program terminates normally.
				<br>
				<br>
