...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>sqrt</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double sqrt(double x);</div>
				<br>
	<h2>Compute square root </h2>
				<br>
				<div class="header2">
	...
	Floating point value.
				<br>
	If the argument is negative, a domain error occurs, setting the gloabal variable errno to the value EDOM.
				<br>
				<br>
	<h3>Return Value</h3>
	Square root of x.
