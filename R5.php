	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> comments</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				...
				<br>
				<p>
Java supports two types of comments:</br> /* multiline comment */ : The compiler ignores everything from /* to */ .</br> The comment can span over multiple lines.</br> // single line : The compiler ignores everything from // to the end of the line.</p>
<br>
<br>
<h3> Syntax</h3>
<p>/* multiline comment */ : The compiler ignores everything from /* to */. The comment can span over multiple lines.
