...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>strchr</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">char *strchr(const char *str,int char);</div>
				<br>
	<h2>Locate first occurrence of character in string</h2>
				<br>
				<div class="header2">
	Returns a pointer to the first occurrence of char in the C string str.
				<br>
				<br>
	...
	Character to be located. It is passed as its int promotion, but it is internally converted back to char.
				...
				<br>
	<h3>Return Value</h3>
	A pointer to the first occurrence of char in str.
				<br>
