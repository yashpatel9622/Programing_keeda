...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>va_arg</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdarg.h></h2></div>
				<div class="header1">type va_arg(va_list ap, type);</div>
				<div class="header1">void va_end(va_list argptr);</div>
				<div class="header1">void va_start(va_list argptr, last_parm);</div>
				<br>
	<h2>Retrieve next argument</h2>
				<br>
				<div class="header2">
	This macro expands to an expression that has the type type and the value of the next argument in the variable argument list.
				<br>
				<br>
	...
	Notice that va_arg cannot determine the actual type of the argument passed to the function, but uses whatever type is passed as the type macro argument as its type.
				<br>
				<br>
	Notice also that va_arg does not determine either whether the retrieved argument is the last argument passed to the function (or even if it is an element past the end of that list). The function should be designed in such a way that the amount of parameters can be inferred in some wat by the values of either the named parameters or the additional arguments already read.
				<br>
				<br>
	<h3>Parameters</h3>
	ap 	
