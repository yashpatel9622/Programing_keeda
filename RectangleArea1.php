...
<body>
	...
	int main()
	{
		...
		return(0);
				...
				<br>
				<br>
				<img src="RectangleAreaOP.png" alt="c programming label"> 
				<div class="but">
					<a href="CircleArea1.php" class="button prev">&laquo;prev</a>
					<a href="SquareArea1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
