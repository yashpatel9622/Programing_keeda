  ...
  public static void main(String[] args)  {  
    ...
    System.out.println("armstrong number");   
        ...
        System.out.println("Not armstrong number");   
				...
				<br>
				<br>
				<img src="i15.png" alt="c programming label"> 
				<div class="but">
				<a href="A14.php" class="button prev">&laquo;prev</a>
				<a href="A16.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
