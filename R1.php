	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1 style=font-size:50px><center><i><b><p>  Quick basics</p></b></i></center></h1>
				<hr>
				<br>
				<br>
			
				<div class="header1">
						<p> Learn Java in simple and easy steps starting from basic to advanced concepts with examples including Java Syntax Object Oriented Language, Methods, Overriding, Inheritance, Polymorphism, Interfaces, Packages, Collections, Networking, Multithreading, Generics, Multimedia, Serialization, GUI.</p>
						
						<br>
						<br>
						
						<h2> Syntax for a stand alone application in java </h2>
						<br>
<br>
						<pre> 
...
<h2> Steps for run a java program </h2>
<br>
<br>
<p>1.Save the program. After using a text editor, such as NotePad, to create your Java program,save the program with a .java extension. ...
<br>2.Open Command Prompt/Terminal. ...
<br>3.Navigate to the correct folder. ...
<br>4.Compile the program. ...
<br>5.Run the program.
</p>
<br>
<br>
<h2>  java reserved keyword </h2>
<br>
<pre>
