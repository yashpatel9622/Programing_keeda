...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>isalpha</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int isalpha(int c);</div>
				<br>
	<h2>Check if character is alphabetic</h2>
				<br>
				<div class="header2">
	...
	In the default C locale, what constitutes a letter is what returns true by either isupper or islower.
				<br>
				<br>
	<h3>Parameters</h3>
	c
