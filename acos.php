...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>acos</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double acos(double x);</div>
				<br>
	<h2>Compute arc cosine</h2>
				<br>
				<div class="header2">
	...
	x
	 ...
	 Floating point value in the interval [-1, +1]. 
				<br>
	 If the argument is out of this interval, a domain error occurs, setting the global variable error to the value EDOM.
				<br>
				<br>
	<h3>Return Value</h3>
