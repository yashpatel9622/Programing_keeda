	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Scope of variable in lifetime</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Scope of variable in lifetime</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
				...
				<p>
The scope of a declaration is the part of the program for which the declaration is in effect.</br>lifetime of a variable or object is the time period in which the variable/object has valid memory. </br>Lifetime is also called "allocation method" or "storage duration.".
Scope of a variable refers to in which areas or sections of a program can the variable be accessed and lifetime</br> variable refers to how long the variable stays alive in memory.

General convention for a variable’s scope is, it is accessible only within the block in which it is declared. </br>A block begins with a left curly brace { and ends with a right curly brace }.

As we know there are three types of variables: </br>1) instance variables,<br> 2) class variables and <br>3) local variables,<br> we will look at the scope and lifetime of each of them now
</p>
