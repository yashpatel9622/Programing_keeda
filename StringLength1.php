...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="StringLengthOP.png" alt="c programming label"> 
				<div class="but">
					<a href="PrintString1.php" class="button prev">&laquo;prev</a>
					<a href="CompareString1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
