...
<body>
	...
	void main()
	{
		...
		printf("\nSimple Interest:%d",ans);
				...
				<br>
				<br>
				<img src="SimpleInterestOP.png" alt="c programming label"> 
				<div class="but">
					<a href="GrossSalary1.php" class="button prev">&laquo;prev</a>
					<a href="CircleArea1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
