...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>rand</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">int rand(void);</div>
				<br>
	...
	This number is generated by an algorithm that returns a sequence of apparently non-related numbers each time it is called. This algorithm uses a seed to generate the series, which should be initialized to some distinctive value using srand.
				<br>
				<br>
	RAND_MAX is a constant defined in <stdlib.h>. Its default value may vary between implementations but it is granted to be at least 32767.
				<br>
				<br>
