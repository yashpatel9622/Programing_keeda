	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Strucutre of an applet </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Strucutre of an applet<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>The SimpleApplet class extends Applet class, which extends the Panel class, </br> which extends the Container class. The Container class extends Object , </br>which is the parent of all Java API classes. The Applet class provides the init , start , stop , destroy , and paint</br> methods you saw in the example applet.
...
The SimpleApplet class is declared public so the program that runs the applet (a browser or appletviewer),</br> which is not local to the program can access it.

Run the Applet

To see the applet in action, you need an HTML file with </br>the Applet tag as follows:
