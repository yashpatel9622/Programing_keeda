...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>abort</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">void abort(void);</div>
				<br>
	<h2>Abort current process</h2>
				<br>
				<div class="header2">
	...
	The function generates the SIGABRT signal, which by default causes the program to terminate returning an unsuccessful termination error code to the host environment.	
				<br>
				<br>
	The program is terminated without calling any atexit function.
				<br>
				<br>
