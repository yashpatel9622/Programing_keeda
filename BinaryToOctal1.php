...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="BinaryToOctalOP.png" alt="c programming label"> 
				<div class="but">
					<a href="BinaryToDecimal1.php" class="button prev">&laquo;prev</a>
					<a href="BinaryToHexa1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
