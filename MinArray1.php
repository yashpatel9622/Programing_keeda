...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Minimum element in array</h1>
				<div class="MinArray">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		printf("Minimum element is present at location 
		%d and its value is %d.\n",location,maximum);
		return 0;
	}
						</code>
					</pre>
				...
				<br>
				<br>
				<img src="MinArrayOP.png" alt="c programming label"> 
				<div class="but">
					<a href="MaxArray1.php" class="button prev">&laquo;prev</a>
					<a href="Array1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
