	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>ctime</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< time.h></h2></div>
				<div class="header1">char *ctime(const time_t *time);</div>
				<br>
	<h2>Convert time_t value to string</h2>
				<br>
				<div class="header2">
	Converts the time_t object pointed by time to a C string containing a human-readable version of the corresponding local time and date.
				<br>
				<br>
