...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<br>
			<br>
			<center><table border="1" width="50%" height="500">
				...
				<tr>
					<td><a href="isalnum.php">isalnum</a></td>
					<td>tests for any alphanumeric character</td>
				</tr>
				<tr>
					<td><a href="isalpha.php">isalpha</a></td>
					<td>tests for any alphabetic character</td>
				</tr>
				<tr>
					<td><a href="iscntrl.php">iscntrl</a></td>
					<td>tests for any control character</td>
				</tr>
				<tr>
					<td><a href="isdigit.php">isdigit</a></td>
					<td>tests for any digit</td>
				</tr>
				<tr>
					<td><a href="isgraph.php">isgraph</a></td>
					<td>tests for any graphical character</td>
				</tr>
				<tr>
					<td><a href="islower.php">islower</a></td>
					<td>tests for any lowercase character</td>
				</tr>
				<tr>
					<td><a href="isprint.php">isprint</a></td>
					<td>tests for any printing character</td>
				</tr>
				<tr>
					<td><a href="ispunct.php">ispunct</a></td>
					<td>tests for any punctuation character</td>
				</tr>
				<tr>
					<td><a href="isspace.php">isspace</a></td>
					<td>tests for any whitespace character</td>
				</tr>
				<tr>
					<td><a href="isupper.php">isupper</a></td>
					<td>tests for any uppercase character</td>
				</tr>
				<tr>
					<td><a href="isxdigit.php">isxdigit</a></td>
					<td>tests for any hexadecimal</td>
				</tr>
				<tr>
					<td><a href="tolower.php">tolower</a></td>
					<td>converts a character to lowercase</td>
				</tr>
				<tr>
					<td><a href="toupper.php">toupper</a></td>
