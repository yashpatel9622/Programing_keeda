	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Arrays</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Arrays</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>

	<p>You can either use array declaration or array literal (but only when you declare and affect the variable </br>right away, array literals cannot be used for re-assigning an array).
<br>
<br>
<b>Declaration<b>
...
int[] myIntArray = new int[]{1,2,3};</p>
<br>
<br>
<h3> One dimenssional array </h3>
<p>Syntax for default values:
