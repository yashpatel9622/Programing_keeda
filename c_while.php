...
#left-panel{width:22%;height:2420px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
		...
		{
			padding:10px;		
			width:2420;	background-color:#eda150;
...
#right-section{width:73%;height:2400px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<p>A while loop in C programming repeatedly executes a target statement as long as a given condition is true.</p>
				<br>
...
<div class="but">
				<a href="c_loop.php" class="button prev">&laquo;prev</a>
				<a href="c_do.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
