	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Super keyword</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Super Keyword</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<h1> Super keywords</h1>
<p>The super keyword in java is a reference variable which is used to refer immediate parent class object.

Whenever you create the instance of subclass, an instance of parent class is created implicitly which is</br>referred by super reference variable.
</p>
