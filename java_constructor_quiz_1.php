...
<li><a href="java_file_manag_quiz_1.php">Java File Management 1</a></li>
  ...
  <h1 style=color:green;>Quiz : Java constructer</h1>
  <br>
  <br>
  <ol class="quiz">
  <div class="q1">
    <li>
  <b>Que 1:______ is  a used to initialize the memory  to an object?</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: constructer has no __________ not even void?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. operator </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  return type</label></li>
	...
	<br>
	 <div class="q1">
    <li>
<b>Que 3:constructer has same name has_______name</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
<b> Que 4:  constructer may be _______?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.private public or procted</label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  static</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. final</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All of these</label></li>
       </ul>
    </li>
	</div>
 ...
 <b>Que 5:  declaring constructer is _________?</b>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: types of constructer is?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.parameterize constructer </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.default constructer</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. both A & B</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 7:A constructer which does not have anyargument is calles_______?</b>
      <ul class="answers">
          <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.parameterize constructer </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.default constructer</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. both A & B</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8: A constructer which does  have anyargument is called_______?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.parameterize constructer </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.default constructer</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. both A & B</label></li>
	...
	<br>
	 <div class="q1">
    <li>
  <b>Que 9: const_nm () is a ________type of constructer? </b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.parameterize constructer </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.default constructer</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. both A & B</label></li>
	...
	<br>
	 <div class="q1">
    <li>
   <b>Que 10:const(arg1,arg2,_____argn) is a which type of constructer?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.parameterize constructer </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.default constructer</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. both A & B</label></li>
