...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>tmpnam</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">char *tmpnam(char *name);</div>
				<br>
	<h2>Generate temporary filename</h2>
				<br>
				<div class="header2">
	...
	This string can be used to create a temporary file without overwriting any other existing file.
				<br>
				<br>
	If the name argument is a null pointer, the resulting string is stored in an internal static array that can be accessed by the return value. The content of this string is stored until a subsequent call to this same function erases it.
				<br>
				<br>
	If the name argument is not a null pointer, it must point to an array of at least L_tmpnam bytes that will be filled with the proposed tempname. L_tmpnam is a macro constant defined in < stdio.h>.
				<br>
				<br>
	...
	A pointer to the C string containing the proposed name for a temporary file.
				<br>
	If name was a null pointer, this points to an internal buffer that will be overwritten the next time this function is called.
				<br>
	If name was not a null pointer, name is returned.
				<br>
