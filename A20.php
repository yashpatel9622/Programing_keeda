	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Odd Even In Array Example{</h1>
				<div class="cex">
					<pre>
						<code class="ccode" >
...
System.out.println(a[i]);  
				...
				<br>
				<br>
				<img src="i20.png" alt="c programming label"> 
				<div class="but">
				<a href="A19.php" class="button prev">&laquo;prev</a>
				<a href="A21.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
