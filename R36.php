	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Graphics class</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Graphics class<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>
The Graphics class is the abstract super class for all graphics contexts which allow an</br> application to draw onto components that can be realized on various</br> devices, or onto off-screen images as well. A Graphics object</br> encapsulates all state information required for the basic rendering operations that Java supports.
<br>
<br>
<h3>Class methods</h3>
<br>
...
<br><br>
11	abstract boolean drawImage(Image img, int x, int y, Color bgcolor, ImageObserver observer)
Draws as much of the specified image as is currently available.
<br><br>
12	abstract boolean drawImage(Image img, int x, int y, ImageObserver observer)
Draws as much of the specified image as is currently available.
<br><br>
13	abstract boolean drawImage(Image img, int x, int y, int width, int height, Color bgcolor, ImageObserver observer)
Draws as much of the specified image as has already been scaled to fit inside the specified rectangle.
<br><br>
14	abstract boolean drawImage(Image img, int x, int y, int width, int height, ImageObserver observer)
Draws as much of the specified image as has already been scaled to fit inside the specified rectangle.
<br><br>
...
Draws as much of the specified area of the specified image as is currently available, scaling it on </br>the fly to fit inside the specified area of the destination drawable surface.
<br><br>
16	abstract boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2, </br>ImageObserver observer)
Draws as much of the specified area of the specified image as is currently</br> available, scaling it on the fly to fit inside the specified area of the destination drawable</br> surface.
<br><br>
17	abstract void drawLine(int x1, int y1, int x2, int y2)
Draws a line, using the current color, between the points (x1, y1) </br>and (x2, y2) in this graphics context's coordinate system.
<br><br>
...
<br><br>
23	abstract void drawRoundRect(int x, int y, int width, int height, int arcWidth, int arcHeight)
Draws an outlined round-cornered rectangle using this graphics context's current color.
<br><br>
24	abstract void drawString(AttributedCharacterIterator iterator, int x, int y)
Renders the text of the specified iterator applying its attributes in accordance</br> with the specification of the TextAttribute class.
<br><br>
...
Fills the polygon defined by the specified Polygon object with the graphics context's</br> current color.
<br><br>
