...
#left-panel{width:22%;height:2220px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2200px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>if-else Statements</p></b></i></center></h1></div>
				...
				<br>
				<p>The syntax of an if...else statement in C++ programming language is −</p>
				<div class="holder2">
				<pre><code>
	if(condition) 
	{
	...
	else 
	{
		Program statement 2;
				...
				<div class="holder3">
					<ul>
						<li>The if-else is actually just an extension of the general format of if statement.If the result of the condition is true,then program statement 1 is executed else program statement 2 will be executed.
					</ul>
				</div>
				<div class="example"><h4>Flowchart:</h4></div>
				<center><img src="flowchart-if-else-statement.png" alt="if-else-stat"></center> 
...
<div class="but">
				<a href="cpp_if.php" class="button prev">&laquo;prev</a>
				<a href="cpp_nested.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
