...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Defination & Declaration</p></b></i></center></h1></div>	
				
				<div class="holder3">
		
					<ul>
					<li>A function definition contains function name, parameters, its code and return type and A function declaration contains only name and return type.</li>
					<br>
					<li>User can define a function only once but it can be declared several times.</li>
					<br>
				</div>
					<h4 style=color:green>declaration of function</h4>
	...
	int main()
	{
		int x-10, y-25, printf"%dn" area(xy):
		return 0;
	}
					...
					<h4 style=color:green>definition of function</h4>
					<h5 style=color:red>Syntax</h5>
					<div class="holder2">
						<pre>
							<code>
	...
	int area(int x, int y)
	{
		...
		retrun z;
					...
					<div class="but">
						<a href="c_func.php" class="button prev">&laquo;prev</a>
						<a href="c_lib.php" class="button next">next &raquo;</a>
					</div>
				</div>
			</div>
			<div id="footer">
