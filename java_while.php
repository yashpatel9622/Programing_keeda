...
<div id="right-section">
				...
				<div class="holder2">
					...
					<ul>
					<b> While loop:</b> this is alooping or repeating statement.it executes a block of code or statement till the given condition is true.
				<br>
				    Syntax: <br>while(expression)
						<br>
					        {
								<br>								statement;
								<br>
			...
			<div class="but">
				...
				<a href="java_switch.php" class="button next">prev &raquo;</a>
				<a href="java_do.php" class="button next">next &raquo;</a>
				</div>
</div>
