...
t2.start();  
				...
				<br>
				<br>
				<img src="i46.png" alt="c programming label"> 
				<div class="but">
				<a href="A45.php" class="button prev">&laquo;prev</a>
				<a href="A47.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
