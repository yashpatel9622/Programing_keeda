	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Header Files in C++ </p></b></i></center></h1></div>	
				
				<div class="holder2">
					<p>Each header file contains information (or declarations) for a particular group of functions.Like stdio.h header file contains declarations of standard input and output functions available in C++ which is used for get the input and print the output.Similarly,the header file math.h contains declarations of mathematical functions availablein C++.
						<br>
						There are two types of header files.That are 1)System header files and 2)User header files.In user header files,user can define various functions and save it in a header file to use it in next programs.
					</p>
					<br>
					<ul>
						<li>Commonly used header files are:
							<br>
							<ol>
								<li><b>complex.h -</b> Complex number arithmatic</li>
								<li><b>math.h -</b> Common mathematical functions</li>
								<li><b>string.h -</b> String handling</li>
								<li><b>signal.h -</b> Signal handling</li>
								<li><b>iostream.h -</b> Input and output handling</li>
								<li><b>inttypes.h -</b> Format conversions of integer types</li>
								<li><b>iomanip.h -</b> Manipulation of streams.</li>
								<li><b>fstream.h -</b> Used for file handling.</li>
							</ol>
						</li>
					</ul>
					<br>
				...
				<div class="but">
				<a href="cpp_operator.php" class="button prev">&laquo;prev</a>
				<a href="cpp_decision.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
