...
<body>
			...
			<div id="left-panel">
				...
				<div class="sidebar">
					<ul>
						...
						<li><a href="primen.php">Print Prime NumbersY</a></li>
	...
	void main()
	{
		...
		cout<<"Sum of the digits of "<< temp<<" is "
		<< sum;
		getch();
	}
				...
				<br>
				<br>
				<img src="digits.jpg" alt="c programming label"> 
				<div class="but">
					<a href="calc.php" class="button prev">&laquo;prev</a>
					<a href="percent.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
