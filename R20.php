	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Packages</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Packages</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>A package as the name suggests is a pack(group) of classes, interfaces and other packages.</br> In java we use packages to organize our classes and interfaces. We have two types of packages in Java:</br> built-in packages and the packages we can create (also known as user defined package).
</p>
...
2) Built-in package: The already defined package like java.io.*, </br>java.lang.* etc are known as built-in packages.

</p>
<br>
<br>

<h3>Packages and Acces protection in java</h3>
<br>
<br>
<h4>
