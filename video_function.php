...
<body>
	<div id="wrapper">
		...
		<div id="container">
			<div id="left-panel">
				...
				<div class="sidebar">
					<ul>
						...
						<li><a href="video_file.php">Files Operator</a></li>					</ul>
			...
			<br>
			<br>
			<center><h2 style=color:red>Functions in C Programming</h2></center>
			<br>
			<br>
				<center><iframe width="560" height="315" src="https://www.youtube.com/embed/Wp2OLv7L6LY?showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></center>
