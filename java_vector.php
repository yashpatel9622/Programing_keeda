...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Vector</p></b></i></center></h1></div>				
					<ul>
					<b>Vector:</b> vector represents the dynamic array and as the elements are added to the vector its size will be increse dynamically.</li>
					<br>
					Constructor:
					<br>
					1.vector()
					<br>
								...
								2.vector(int size)<br>
								3.vector(int size int incr)<br>
								4.vector(collection)<br>
