	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>isgraph</p></b></i></center></h1>
				<br>
				<hr>
				<br>
			<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int isgraph(int ch);</div>
				<br>
	<h2>Check if character has graphical representation</h2>
				<br>
				<div class="header2">
	Checks if parameter c is a character with graphical representation. The characters with graphical representation 
	are all those characters that can be printed(as determined by isprint) except for whitespace characters (like ‘’),
	which are not considered isgraph characters.
				<br>
				<br>
	<h3>Parameters</h3>
	c
