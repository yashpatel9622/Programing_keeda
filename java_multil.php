...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Multilevel Inheritance</p></b></i></center></h1></div>				
					<ul>
					<b>Multilevel Inheritance:</b>it refers to a mechanism in oo technology where one can inherit from a derived class thereby this derived class the base class for new one class<br>					
					<b>Example:</b>
					class A{<br>
					}<br>
			...
			<div class="but">
				...
				<a href="java_multiple.php" class="button next">prev &raquo;</a>
				<a href="java_hybrid.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
