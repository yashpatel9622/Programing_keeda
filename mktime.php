	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>mktime</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< time.h></h2></div>
				<div class="header1">time_t mktime(struct tm *time);</div>
				<br>
	<h2>Convert tm structure to time_t</h2>
				<br>
				<div class="header2">
	Interprets the contents of the tm structure pointed by time as a calendar time expressed in local time. This calendar time is used to adjust the values of the members of time accordingly and returned as an object of type time_t.
				<br>
				<br>
	The original values of the members tm_wday and tm_yday of time are ignored, and the ranges of values for the rest of its members are not restricted to their normal values (like tm_mday being between 1 and 31).
				<br>
				<br>
	The object pointed by time is modified, setting the tm_wday and tm_yday to their appropiate values, and modifying the other members as necessary to values within the normal range representing the specified time.
				<br>
				<br>
	<h3>Parameters</h3>
	time
