...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>errno</p></b></i></center></h1>
				<br>
				<hr>
				<br>
	<h2>Last error number</h2>
				<br>
				<div class="header2">
	This macro expands to a modifilable lvalue of type int,therefore it can be both read and modified by a program.
					<br>
					<br>
	errno is set to zero at program startup, and certain functions of the standard C library modify its value to some value different from zero to signal some types of error.You can also modify its value or reset to zero at your convenience.
					<br>
					<br>
	The same header that declares errno (< errno.h>) also declares at least the following two macro constants with value different from zero:
					<br>
	<b>EDOM</b>
					<br>
	<b>ERANGE</b>
				...
				<br>
				<br>
				<h1><center><i><b><p>EDOM</p></b></i></center></h1>
				<br>
				<hr>
				<br>
	<h2>Represents a domain error</h2>
				<br>
				<div class="header3">
	Certain math functions sets the value of errno to EDOM if a domain error occurs.
					<br>
					<br>
	Some mathematical functions are only defined for certain real values, which is called its domain, for example the square root function is only defined for non-negative numbers, therefore the sqrt functions sets errno to EDOM if called with a negative argument.
					<br>
					<br>
				</div>
				<hr>
