...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Factorial using function</h1>
				<div class="FactFunction">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		printf("Enter a number to calculate its
		factorial\n");
		scanf("%d",&number);
	...
	long factorial(int n)
	{
		...
		return result;
				...
				<br>
				<br>
				<img src="FactFunctionOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Temperature1.php" class="button prev">&laquo;prev</a>
					<a href="FactRecursion1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
