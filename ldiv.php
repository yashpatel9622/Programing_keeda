...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>ldiv</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">ldiv_t ldiv(long numerator,long denominator);</div>
				<br>
	<h2>Integral division</h2>
				<br>
				<div class="header2">
	...
	Denominator.
				...
				<br>
	<h3>Return Value</h3>
	The result is returned by value in a ldiv_t structure (defined in <stdlib.h>), which has two members, in either order:
				<br>
	long quot; long rem; 
				</div>
