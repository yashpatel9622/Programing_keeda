...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="BinarySearchOP.png" alt="c programming label"> 
				<div class="but">
					<a href="LinearSearch1.php" class="button prev">&laquo;prev</a>
					<a href="BubbleSort1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
