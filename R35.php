...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Passing parameter to an applet </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Passing parameter to an applet<h2></div>
				<div class="header1">
				<br>
				<br>
	...
	<p>
This string should match the name of a PARAM element in the HTML page. getParameter()</br> returns the value of the parameter. All values are passed as strings.</br> If you want to get another type like an integer, then you'll need to pass</br> it as a string and convert it to the type you really want.Jul 1, 2005
</p>
<br>
<br>
<h3>The program below demonstrates this with a generic string drawing applet. </br>The applet parameter "Message" is the string to be drawn.
</h3>
<p>
