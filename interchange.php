...
<body>
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="interchange.jpg" alt="c programming label"> 
				<div class="but">
					<a href="addn.php" class="button prev">&laquo;prev</a>
					<a href="reverseno.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
