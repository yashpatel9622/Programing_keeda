...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Decimal to Binary Bitwise</h1>
				<div class="Structure">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	void  main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="DecimalToBinaryBitOP.png" alt="c programming label"> 
				<div class="but">
					<a href="PascalTriangle1.php" class="button prev">&laquo;prev</a>
					<a href="DecimalToBinary1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
