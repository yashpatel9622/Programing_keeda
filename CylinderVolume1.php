...
<body>
	...
	void main()
	{
		...
		vol=pie*r*r*h;
		printf("\nVolume of Cylinder is:-%3.2f",vol);
	}
						</code>
					</pre>
				</div>
				...
				<br>
				<br>
				<img src="CylinderVolumeOP.png" alt="c programming label"> 
				<div class="but">
					<a href="CubeVolume1.php" class="button prev">&laquo;prev</a>
					<a href="SphereVolume1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
