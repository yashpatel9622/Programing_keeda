...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>cosh</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double cosh(double x);</div>
				<br>
	<h2>Compute hyperbolic cosine</h2>
				<br>
				<div class="header2">
	...
	Hyperbolic cosine of x.
				<br>
	If the magnitude of the result is so large that it cannot be represented in an object of the return type, the function return HUGE_VAL, and the value of the global variable error is set to the ERANGE value
				</div>
