	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> final keyword</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>final keyword</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
			...
			<p>
final keyword in java. final keyword is used in different contexts. First of all, final is a non-access modifier</br> applicable only to a variable, a method or a class.Following are different contexts where final is used.</br> When a variable is declared with final keyword, it's value can't be modified,essentially, a constant.
...
<h3> Final classes</h3>
<p>
Writing Final Classes and Methods. You can declare some or all of a class's methods final.</br> You use the final keyword in a method declaration to indicate that the method cannot be overridden by subclasses.  </br>The Object class does this—a number of its methods are final .
</p>
<br>
<br>
<h3> final methods</h3>
<p>You can declare some or all of a class's methods final. You use the final keyword in a method</br> declaration to indicate that the method cannot be overridden by subclasses. </br>The Object class does this—a number of its methods are final .
</p>
<br>
<br>
</h3> Example</h3>
