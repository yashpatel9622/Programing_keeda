...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="SwappingOP.png" alt="c programming label"> 
				<div class="but">
					<a href="GreaterNumber1.php" class="button prev">&laquo;prev</a>
					<a href="NestedIfElse1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
