...
<body>
	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>iscntrl</p></b></i></center></h1>
				<br>
				<hr>
				<br>
			<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int iscntrl(int c);</div>
				<br>
	<h2>Check if parameter c is a control character</h2>
				<br>
				<div class="header2">
	...
	plus 0x7f(DEL),although specific compiler implementations for certain platforms may define additional control 
	characters in the extended character set (above 0x7f).
				<br>
				<br>
