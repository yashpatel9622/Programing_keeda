...
<body>
	...
	void main()
	{
		...
		printf("\nPercentage:%f",per);
				...
				<br>
				<br>
				<img src="PercentageOP.png" alt="c programming label"> 
				<div class="but">
					<a href="NestedIfElse1.php" class="button prev">&laquo;prev</a>
					<a href="GrossSalary1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
