	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Exception handling  techniques</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Exception handling techniques<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
In Java, an exception is an object that wraps an error event that occurred</br> within a method and contains:
