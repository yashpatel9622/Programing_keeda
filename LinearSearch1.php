	...
	int main()
	{
		...
		if(c==n)
			...
			return 0;
				...
				<br>
				<br>
				<img src="LinearSearchOP.png" alt="c programming label"> 
				<div class="but">
					<a href="DeleteArray1.php" class="button prev">&laquo;prev</a>
					<a href="BinarySearch1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
