	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<h3 style=color:green>Difference between C Variable, C Array and C Structure:</h3>
<div class="holder3">
		
				<ul>
				<li>A normal C variable can hold only one data of one data type at a time. </li>
				<br>
				<li>An array can hold group of data of same data type.</li>
				<br>
				<li>A structure can hold group of data of different data types and Data types can be int, char, float, double and long double etc.</li>

				</div>
<h3 style=color:green>C Structure:</h3>
...
<h4 style=color:red>Example:</h4>
	...
	b = “Hello”;
				...
				<div class="but">
				<a href="c_pointer.php" class="button prev">&laquo;prev</a>
				<a href="c_union.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
