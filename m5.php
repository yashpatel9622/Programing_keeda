...
<center style=font-size:25px;><h1 style=color:green;>std::setbase</h1></center>
						<br>
						<hr>
						<br>
...
<br>
		<h2>Description</h2>
<br>
		<p style=font-size:25px>Reset format flags: Unsets the format flags specified by parameter mask. Behaves as<br>
 if they were unsetf were called with mask as argument on the stream on which it is inse<br>
 rted / extracted as a manipulator (it can be inserted / extracted on input streams or <br>
 output streams). See the base: fmtflags for more information on the particular flags <br>
 that can be modified with this manipulator function. This manipulator is declared in <br>
 header Kiomanip 
</p>
<br>
<h2>prototype</h2>
<br>
<b style=font-size:25px>Prototype / * unspecified * / resetiosflags (ios base: fmtflags mask);       </b><br>
<h2>parameters</h2>
<br>
<p style=font-size:25px>

 Parameters Parameters mask Mask representing the flags to be reset. fmtflags is a bitmask type. 
 </p>
 
 <h2> return value</h2>
 <br>
 <p style=font-size:25px>Return value Unspecified. This function should only be used as a stream manipulator.
