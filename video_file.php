...
<div id="topic_logo"> <img src="c.png" alt="cprogramming-Logo"> </div>
			...
			<br>
			<br>
			<center><h2 style=color:red>Files Operator in C Programming</h2></center>
			<br>
			<br>
				<center><iframe width="560" height="315" src="https://www.youtube.com/embed/GYf6AwK1VQU?showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>></center>
