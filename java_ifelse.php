...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>If-else Statement</p></b></i></center></h1></div>	
				<div class="holder2">
				
					<ul>
						<b> If-else Statement: </b>the "if-else" statement an extension of if statement that provides another option when "if" statement evaluates  to "false" i.e.else block ias executed if "if" statement if false.
					<br>
					    Syntax:<br> If(condition_expression)
						<br>
					    {
							<br>
							(statement);
			...
			<div class="but">
				...
				<a href="java_if.php" class="button next">prev &raquo;</a>
				<a href="java_nested.php" class="button next">next &raquo;</a>
				</div>
