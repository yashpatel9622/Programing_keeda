...
#left-panel{width:22%;height:3220px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:3200px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<p>The switch case statement is a multiway decision making statement.Unlike the multiple decision statement that can be created using if-else,the switch statement evaluates the conditional expression and tests it against the numerous constant values.During execution,the branch corresponding to the value that the expression matches it taken.</p>
				<br>
				<p>The value of the expression in a switch-case statement must have to be an ordinal type i.e. integer,char,short,long,etc.Double and Float are not allowed.
	...
	Your grade is B
			...
			<div class="but">
				<a href="cpp_elseif.php" class="button prev">&laquo;prev</a>
				<a href="cpp_loop.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
