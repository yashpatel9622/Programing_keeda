...
<body>
	<div id="wrapper">
		...
		<nav>
			...
			</div><li><a href="A2.php">Print Hello java</a></li>
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Samllest in array example</h1>
				<div class="cex">
					<pre>
						<code class="ccode" >
...
System.out.println("Smallest: "+getSmallest(b,7));  
				...
				<br>
				<br>
				<img src="i22.png" alt="c programming label"> 
				<div class="but">
				<a href="A21.php" class="button prev">&laquo;prev</a>
				<a href="A23.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
