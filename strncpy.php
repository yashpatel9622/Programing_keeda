	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>strncpy</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">char *strncpy(char *destination,const char *source,size_t count);</div>
				<br>
	<h2>Copy characters from string</h2>
				<br>
				<div class="header2">
	Copies the first count characters of source to destination. If the end of the source C string (which is signaled by a null-character) is found before count characters have been copied, destination is padded with zeros until a total of count characters have been written to it.
				<br>
				<br>
	No null-character is implicitly appended to the end of destination, so destination will only be null-terminated if the length of the C string in source is less than count.
				<br>
				<br>
	<h3>Parameters</h3>
	destination
