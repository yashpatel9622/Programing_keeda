...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="ConcatenateStringOP.png" alt="c programming label"> 
				<div class="but">
					<a href="CopyString1.php" class="button prev">&laquo;prev</a>
					<a href="RverseString1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
