...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="additionOP.png" alt="c programming label"> 
				<div class="but">
					<a href="integer1.php" class="button prev">&laquo;prev</a>
					<a href="areaTriangle1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
