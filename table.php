...
<body>
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="table.jpg" alt="c programming label"> 
				<div class="but">
					<a href="grade.php" class="button prev">&laquo;prev</a>
					<a href="primen.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
