...
<body>
	...
	void main()
	{
		...
		cin>>end;
		cout<<"Prime Number Between "<< start<<" and "<< 
		end<<" is :\n";
		for(i=start; i<=end; i++)
		{
			count=0;
		...
		getch();
				...
				<br>
				<br>
				<img src="primen.jpg" alt="c programming label"> 
				<div class="but">
					<a href="table.php" class="button prev">&laquo;prev</a>
					<a href="addn.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
