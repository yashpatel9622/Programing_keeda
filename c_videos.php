	...
	<div id="wrapper">
		...
		<div id="container">
			<div id="left-panel">
				...
				<div class="sidebar">
					<ul>
					<li><a href="c_videos.php">Introduction</a></li>
			...
			<br>
			<center><h2 style=color:red>C Introduction</h2></center>
			<br>
				<center><video width="700" height="400" controls>
			<source src="c_introduction.mp4" type="video/mp4">
			</video></center>
		...
		<div id="footer">
			...
			<br>
			<div class="holder5"><center>Copyright © 2019 programmingKeeda.com | All rights reserved.</center></div></div><div class="holder5"><center>Copyright © 2018 DiplomaLang.com | All rights reserved.</center></div>
		</div>
	</div>
</body>
</html>