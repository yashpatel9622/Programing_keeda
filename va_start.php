...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>va_start</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdarg.h></h2></div>
				<div class="header1">void va_start(va_list ap, last param);</div>
				<br>
	<h2>Initialize a variable argument list</h2>
				<br>
				<div class="header2">
	Initializes the object of type va_list passed as argument ap to hold the information needed to retrieve the additional arguments after parameter last_param with function va_arg.
				<br>
				<br>
	...
	ap 	
				<br>
	Object of type va_list that will hold the information needed to retrieve the additional argument with va_arg.
				<br>
	Last_param
				<br>
