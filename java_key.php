...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Keywords</p></b></i></center></h1></div>				
					<ul>
					There are two types of keywords.
					<br>
					<b>1.Super Keyword:</b> it used to call the constructor of immediate super class.super keyword is used to refer variablr of super class that has same name of sub class variables.
					<br>
					<b>2.This Keyword:</b>this keyword is used to access variables within as
							</ul>   
			...
			<div class="but">
				...
				<a href="java_con.php" class="button next">prev &raquo;</a>
				<a href="java_array.php" class="button next">next &raquo;</a>
				</div>
</div>
