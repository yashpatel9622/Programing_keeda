	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<div class="but">
					<a href="c_intro_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
				<hr>
				<br>
				<br>
				<center><h2>C Control Test<h2></center>
				<br>
				<div class="but1">
					<a href="c_control_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
				<hr>
				<br>
				<br>
				...
				<br>
				<div class="but1">
					<a href="c_function_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
				<hr>
				<br>
				<br>
				...
				<br>
				<div class="but1">
					<a href="c_array_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
				...
				<br>
				<div class="but1">
					<a href="c_string_quiz_1.php" class="button prev">Start Quiz</a>
				</div>

				<hr>
				<br>
				<br>
				<center><h2>C Pointers Test<h2></center>
				<br>
				<div class="but1">
					<a href="c_pointer_quiz_1.php" class="button prev">Start Quiz</a>
				</div>

				<hr>
				<br>
				<br>
				<center><h2>C Structure Test<h2></center>
				<br>
				<div class="but1">
					<a href="c_structure_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
				
				<hr>
				<br>
				<br>
				<center><h2>C Union Test<h2></center>
				<br>
				<div class="but1">
					<a href="c_union_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
				
				<hr>
				<br>
				<br>
				<center><h2>C File I\O Test<h2></center>
				<br>
				<div class="but1">
					<a href="c_fileio_quiz_1.php" class="button prev">Start Quiz</a>
				</div>
