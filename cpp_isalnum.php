...
<i>Description</i>
<p>
check if character isalphanumeric; checkswhether c is either a decimal digit or </br>an uppercase or alowercase latter. 
The result is true if either isalpha would alsoreturn true. </br>Notice that what is considerd aletter may depend on the locale being used;
In thedefault "C" locale what constitute aletter is what return true</br> by either isupper or islower. for a detailed chart on character of the 
refernce for the <cctype> header. in C++,a locale-specific template </br>version of this function exist in header,(locale)

</p>
<i>prototype</i>
<b>int isalnum(int c);</b>
<i>parameters</i>
<p>
