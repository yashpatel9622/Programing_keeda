	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Constructor</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Constructor</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>A constructor in Java is a block of code similar to a method that's called when an instance of</br> an object is created. Here are the key differences between a constructor and a method: A constructor doesn't have a return type. ... </br>Unlike methods, constructors are not considered members of a class.
