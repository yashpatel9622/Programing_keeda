...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>memcpy</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">void *memcpy(void *to,const void *from,size_t count);</div>
				<br>
	<h2>Copy block of memory</h2>
				<br>
				<div class="header2">
	Copies the values of count bytes from the location pointed by from directly to the memory block pointed by to.
				<br>
				<br>
	...
	The function does not check for any terminating null character in from - it always copies exactly count bytes.
				<br>
				<br>
	To avoid overflows, the size of the arrays pointed by both the to and from parameters, shall be at least count bytes, and should not overlap (for overlapping memory blocks, memmove is a safer approach).
				<br>
				<br>
	<h3>Parameters</h3>
	to	
