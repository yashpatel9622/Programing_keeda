	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Implements Runnable Interface</h1>
				<div class="cex">
					<pre>
						<code class="ccode" >
...
t1.start();  
				...
				<br>
				<br>
				<img src="i43.png" alt="c programming label"> 
				<div class="but">
				<a href="A42.php" class="button prev">&laquo;prev</a>
				<a href="A44.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
