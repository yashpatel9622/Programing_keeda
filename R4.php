	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>  Basic syntax</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Basic syntax</h2></div>
				<div class="header1">
				<br>
				<br>
				<h3> case sensitivity</h3>
	<p>Yes, it is case-sensitive. It is this way because of its heritage from C. To keep the language more</br> familiar to what people were used to "in the day", they left it as case-sensitive.</br> There is an added advantage, since Java identifiers can be almost any Unicode character
	</P>
	<br>
	<br>
	<h3> class names</h3>
	<p>You use someclassname.class when you want to work with the Class object and don't have an object instance. </br..class is a class literal... Just like 5 is an int literal, like 5.0 is a double literal (surprisingly, there is</br> a class named 'Class' in java.lang package).

	</P>
	<br>
	<br>
	<h3>Method names</h3>
	<p>A method is a set of code which is referred to by name and can be </br>called (invoked) at any point in a program simply by utilizing the method's name.</br> Think of a method as a subprogram that acts on data and often returns a value. Each method has its own name.	</p>
	<br>
	<br>
	<h3>public static void main(String args[])</h3>
	<p>public : it is a access specifier that means it will be accessed by publically.</br> static : it is access modifier that means when the java program is load then it will create the space in memory automatically. </br>void : it is a return type i.e it does not return any value. </br>main() : it is a method or a function name.</p>
