	...
	void main()
	{
		...
		else
		{
			printf("error,enter correct value");
				...
				<br>
				<br>
				<img src="SphereVolumeOP.png" alt="c programming label"> 
				<div class="but">
					<a href="CylinderVolume1.php" class="button prev">&laquo;prev</a>
					<a href="Vowel1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
