...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Generate armstrong number</h1>
				<div class="GenerateArmstrong">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		printf("Enter an integer upto which you want 
		...
		return 0;
				...
				<br>
				<br>
				<img src="GenerateArmstrongOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Armstrong1.php" class="button prev">&laquo;prev</a>
					<a href="Temperature1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
