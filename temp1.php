...
#left-panel{width:23%;height:3770px;background-color:#eda150;float:left;padding:10px;}
.sidebar ul
{
list-style:none;
}
...
#right-section{width:73%;height:3770px;background-color:#bcc92b;float:right;padding:10px;}
#right-section p
{
font-size:20px;
...
<div id="footer">
	...
	<br>
	<div class="holder5"><center>Copyright © 2019 ProgrmmingKeeda.com | All rights reserved.</center></div>
</div>
</div>
</div>
</body>
