	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>memmove</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">void *memmove(void *to,const void *from,size_t count);</div>
				<br>
	<h2>Move block of memory</h2>
				<br>
				<div class="header2">
	Copies the values of count bytes from the location pointed by from to the memory block pointed by to. Copying takes place as if an intermediate buffer was used, allowing the to and from to overlap.
				<br>
				<br>
	The underlying type of the objects pointed by both the from and to pointers are irrelevant for this function; The result is a binary copy of the data.
				<br>
				<br>
	The function does not check for any terminating null character in from - it always copies exactly count bytes.
				<br>
				<br>
	To avoid overflows, the size of the arrays pointed by both the destination and source parameters, shall be at least count bytes.
				<br>
				<br>
	<h3>Parameters</h3>
	to	
