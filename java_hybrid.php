...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Hybrid Inheritance</p></b></i></center></h1></div>				
					<ul>
					<b>Hybrid Inheritance:</b>in simple term you can say that hybrid inheritance is a combination of single and multiple inheritance.<br><br>
					                        a Hybrid inheritance can be achived in the java in same way as multiple inheritance can be using interfaces yes you heard it right by using interfaces you can have multiple as well as hybrid inheritance in java.<br>
					<br>					
					<b>Example:</b>
					class A{<br>
					}<br>
			...
			<div class="but">
				...
				<a href="java_multil.php" class="button next">prev &raquo;</a>
				<a href="java_thread.php" class="button next">next &raquo;</a>
				</div>
</div>
