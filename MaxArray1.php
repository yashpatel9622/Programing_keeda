...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Maximum element in array</h1>
				<div class="MaxArray">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="MaxArrayOP.png" alt="c programming label"> 
				<div class="but">
					<a href="BinaryToHexa1.php" class="button prev">&laquo;prev</a>
					<a href="MinArray1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
