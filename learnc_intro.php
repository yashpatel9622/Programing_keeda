	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<div class="holder2">				
					<ul>
						<li>The C programming language is a general-purpose, high-level language (generally denoted as structured language). C programming language 				was at first developed by Dennis M. Ritchie at At&T Bell Labs.</li>
						<br>
						<li>C is one of the most commonly used programming languages. It is simple and efficient therefore it become best among all. It is used in 				all extents of application, mainly in the software development.</li> 
						<br>
						<li>Many software's & applications as well as the compilers for other programming languages are written in C also Operating Systems like 				Unix, DOS and Windows are written in C.</li>
						<br>
						<li>C has many powers, it is simple, stretchy and portable, and it can control System Hardware easily. It is also one of the few languages 				to have an international standard, ANSI C.</li>
					</ul>
				</div>
				<div class="holder3"><h1><center><i><b><p>Facts About C</p></b></i></center></h1></div>
				<div class="holder4">
					<p>
					<ul>
						<li>C was invented to write an operating system called UNIX.</li>
			
						<li>C is a successor of B languge which was introduced around the early 1970s.</li>
			
						<li>The language was formalized in 1988 by the American National Standard Institude(ANSI).</i>
						...
						<li>Todays most popular Linux OS and RDBMS MySQL have been written in C.</li>
					</ul>
				</div>
				<div class="holder5"><h1><center><i><b><p>Why use C?</p></b></i></center></h1></div>
				<div class="holder6">				
					<ul>
						<li>C was initially used for system development work,particularly the programs that make-up the oprating system. C was adopted as a system develpoment language because it produce code written in assembly language.</li>
						<br>
						<li>The C programming language is used for developing system applications that forms a major portion of operating systems such as Windows,UNIX and Linux. Some examples of the use of C might be-<ul>
				...
				<div class="holder8">				
					<ul>
						<li> Fast, Powerful & efficient</li>
						<li>Easy to learn.</li>
						<li> It is portable.</li>
						<li>''Mid-level'' Language</li>
						<li>Widely accepted language</li>
						<li>Supports modular programming style</li>
						<li>Useful for all applications</li>
						<li>C is the native language of UNIX</li>
					</ul>
				</div>
				<div class="but">
					<a href="c_history.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
	<div id="footer">
		...
		<br>	<div class="holder5"><center>Copyright © 2019 ProgrmmingKeeda.com | All rights reserved.</center></div>
	</div>
</div>
</body>
</html>