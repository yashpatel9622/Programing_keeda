...
<center style=font-size:25px;><h1 style=color:green;>deque</h1></center>
			<br>
			<hr>
			<br>
...
<p style=font-size:25px;>
 deque header: header that defnes the deque containers class:</p>
...
<caption><h1>Members of containers</h1></caption>
				...
				<td>construct deque container</td>
				</tr>
				<tr>
				<td>std::deque::~deque</td>
				<td> destruct the deque container</td>
				</tr>
				<tr>
				...
				<tr>
				<td>std::deque::cebing</td>
				<td>Return constant iterator at start of conitener</td>
				</tr>
				
				<tr>
				<td>std::deque:cend</td>
				<td>Return constant iterator at end of conitener</td>
				
				</tr>
				
				<tr>
				<td>std::deque:date</td>
