...
<li><a href="java_file_manag_quiz_1.php">Java File Management 1</a></li>
  ...
  <h1 style=color:green;>Quiz : Java classes and object and methods</h1>
  <br>
  <br>
  <ol class="quiz">
  <div class="q1">
    <li>
  <b>Que 1:______ is  a unit which encapsulate all the methods and datatype?</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: which keyword are used to defining a class?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. key </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  class</label></li>
	...
	<br>
	 <div class="q1">
    <li>
<b>Que 3: ______  of a class called as instance of class</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. class </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  keyword</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. objects</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All</label></li>
       </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b> Que 4:  _________ operator is used to create a object?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. new </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  class</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. delete</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. malloc</label></li>
       </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 5:  declaring object is _________?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.class_nm object_nm </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B. class_nm object_nm class_nm</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. object_nm class_nm </label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All of these</label></li>
      </ul>
    </li>
	</div>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: creating object is _________?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A.object =new classname </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.new classname</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. object =new object</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All of these</label></li>
      </ul>
    </li>
	</div>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 7:_______  operator dynamically allocates memory for an object?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. extend </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  new</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. loop</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All of these</label></li>
      </ul>
    </li>
	</div>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8: object is nothing but ________?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. class</label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. user defined data type</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. for loop</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
  <b>Que 9: _________ is a collection of statement that are grouped together to perform an operation? </b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. class</label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  java operator</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. java methods</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All of these</label></li>
       </ul>
    </li>
	</div>
	...
	<br>
	 <div class="q1">
    <li>
   <b>Que 10:syntax of methods declaration?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. returntype method_nm </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B. method_nm</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. method_nm class</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D.object method_nm</label></li>
      </ul>
    </li>
	<div>
  </ol>
