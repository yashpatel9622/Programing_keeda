		...
		<div id="container">
			...
			<div id="right-section">
				...
				<div class="Structure">
					<pre>
						<code class="ccode">
						<h1><cassert>(cassert.h)</h1>
				<h4>type</h4>
				<i> header</i>
				<h4>Description</h4>
				<p>
				C diagnostics Library:assert.h defines one macro function </br>that are used a standard debuggig tool.
				
				</br>
				</p>
				<table border="1" width="40%" height="100">
			
				<caption><h1>cassert</h1></caption>
				<tr>
					<th>Option</th>
					</tr>
				
				<tr>
				<td><a href="assert.php"> assert</a></td>
				</tr>
				</table>
