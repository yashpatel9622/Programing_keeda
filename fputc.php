	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>fputc</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int fputc(int ch, FILE *stream);</div>
				<br>
	<h2>Write character to stream </h2>
				<br>
				<div class="header2">
	Writes a character to the stream and advances the position indicator.
				<br>
				<br>
	The character is written at the current position of the stream as indicate by the internal position indicator, which is then advanced once character.
				<br>
				<br>
	<h3>Parameters</h3>
	character
