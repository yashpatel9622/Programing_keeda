	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Changing font of an applet </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Changing font of an applet<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<pre>
In java the java,aet.Font class is used to set or retrive the screen Fonts.
<br><br>
<h3>Example</h3>
