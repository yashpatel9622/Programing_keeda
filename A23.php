	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Remove Duplicate In Array Example</h1>
				<div class="cex">
					<pre>
						<code class="ccode" >
    ...
    public static void main (String[] args) {  
        ...
        for (int i=0; i<length; i++)  
           System.out.print(arr[i]+" ");  
				...
				<br>
				<br>
				<img src="i23.png" alt="c programming label"> 
				<div class="but">
				<a href="A22.php" class="button prev">&laquo;prev</a>
				<a href="A24.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
