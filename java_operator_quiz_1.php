...
<li><a href="java_file_manag_quiz_1.php">Java File Management 1</a></li>
  ...
  <h1 style=color:green;>Quiz : Java Operator</h1>
  <br>
  <br>
  <ol class="quiz">
  <div class="q1">
    <li>
  <b>Que 1:operator are______ those represent some operation?</b>
      <ul class="answers">
        <li><input type="radio" name="question-1" id="answer-1-1"><label for="answer-1-1">A.symbols</label> </li>
        <li><input type="radio" name="question-1" id="answer-1-2"><label for="answer-1-2">B. data type</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: which of these types of operator?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. arithmetic </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  relational</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. logical</label></li>
	...
	<br>
	 <div class="q1">
    <li>
<b>Que 3: types of operator is______?</b>
      <ul class="answers">
        <li><input type="radio" name="question-3" id="answer-3-1"><label for="answer-3-1">A. bitwise </label></li>
        <li><input type="radio" name="question-3" id="answer-3-2"><label for="answer-3-2">B. conditional</label></li>
        <li><input type="radio" name="question-3" id="answer-3-3"><label for="answer-3-3">C. incerement/ decrement</label></li>
	...
	<br>
	 <div class="q1">
    <li>
<b> Que 4:  arithmetic operator are used in_______?</b>
      <ul class="answers">
        <li><input type="radio" name="question-4" id="answer-4-1"><label for="answer-4-1">A. numeric expression</label></li>
        <li><input type="radio" name="question-4" id="answer-4-2"><label for="answer-4-2">B. non-numeric expression</label></li>
        <li><input type="radio" name="question-4" id="answer-4-3"><label for="answer-4-3">C. mathematical expression</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 5:  +,-,*,%./ are_____ operator?</b>
      <ul class="answers">
        <li><input type="radio" name="question-5" id="answer-5-1"><label for="answer-5-1">A.conditional</label></li>
        <li><input type="radio" name="question-5" id="answer-5-2"><label for="answer-5-2">B.arithmetic</label></li>
        <li><input type="radio" name="question-5" id="answer-5-3"><label for="answer-5-3">c. logical</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: which of these operator  return true or false result?</b>
      <ul class="answers">
        <li><input type="radio" name="question-6" id="answer-6-1"><label for="answer-6-1"> relational</label></li>
        <li><input type="radio" name="question-6" id="answer-6-2"><label for="answer-6-2">B.logical</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 7: &&,||,! are_______ operator?</b>
      <ul class="answers">
        <li><input type="radio" name="question-7" id="answer-7-1"><label for="answer-7-1">A. relational</label></li>
        <li><input type="radio" name="question-7" id="answer-7-2"><label for="answer-7-2">B. logical</label></li>
        <li><input type="radio" name="question-7" id="answer-7-3"><label for="answer-7-3">C. bitwise</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8: which  of these bitwise operator?</b>
      <ul class="answers">
        <li><input type="radio" name="question-8" id="answer-8-1"><label for="answer-8-1">A. &,|,>>,<< </label></li>
        <li><input type="radio" name="question-8" id="answer-8-2"><label for="answer-8-2">B. +,-,&</label></li>
        <li><input type="radio" name="question-8" id="answer-8-3"><label for="answer-8-3">C.  @,!,$</label></li>
	...
	<br>
	 <div class="q1">
    <li>
  <b>Que 9:conditional operator is also known as________? </b>
      <ul class="answers">
        <li><input type="radio" name="question-9" id="answer-9-1"><label for="answer-9-1">A. logical</label></li>
        <li><input type="radio" name="question-9" id="answer-9-2"><label for="answer-9-2"> B. ternary </label></li>
        <li><input type="radio" name="question-9" id="answer-9-3"><label for="answer-9-3">C. arithmetic</label></li>
        <li><input type="radio" name="question-9" id="answer-9-4"><label for="answer-9-4">D. bitwise</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
   <b>Que 10: --,++ are______ operator?</b>
      <ul class="answers">
        <li><input type="radio" name="quiz-10" id="answer-10-1"><label for="answer-10-1">A.increment/decrement</label></li>
        <li><input type="radio" name="quiz-10" id="answer-10-2"><label for="answer-10-2">B. logical</label></li>
        <li><input type="radio" name="quiz-10" id="answer-10-3"><label for="answer-10-3">C.  conditional</label></li>
        <li><input type="radio" name="quiz-10" id="answer-10-4"><label for="answer-10-4">D. All of these</label></li>
      </ul>
    </li>
	<div>
  </ol>
