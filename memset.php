...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>memset</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">void* memset(void* ptr,int ch,size_t count);</div>
				<br>
	<h2>Fill block of memory</h2>
				<br>
				<div class="header2">
	Sets the first num bytes of the block of memory pointed by ptr to the specified ch (interpreted as an unsigned char).
				<br>
				<br>
	<h3>Parameters</h3>
	ptr
	...
	ch
				<br>
	Value to be set. The value is passed as an int, but the function fills the block of memory using the unsigned char conversion of this ch.
				<br>
				<br>
	num
				<br>
