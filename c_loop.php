...
#left-panel{width:22%;height:2040px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2020px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>C Loop</p></b></i></center></h1></div>	
				
				<div class="holder2">
		
				<ul>
				<li>You may encounter situations, when a block of code needs to be executed several number of times. In general, statements are executed sequentially: The first statement in a function is executed first, followed by the second, and so on</li>
				<br>
				<li>Programming languages provide various control structures that allow for more complicated execution paths.</li>
				<br>
				<li>A loop statement allows us to execute a statement or group of statements multiple times. Given below is the general form of a loop statement in most of the programming languages −</li>
				</ul>
				</div>
				<br>
				<div class="example"><h4>Flowchart:</h4></div>
				<center><img src="flowchart-loop-statement.png" alt="loop-stat"></center> 
				<table style="width:100%">
					...
					<tr>
						<td>1</td>
						<td><a href="c_while.php">while loop</a></td>
					...
					<tr>
						<td>2</td>
						<td><a href="c_for.php">	for loop</a></td>
						<td>Executes a sequence of statements multiple times and abbreviates the code that manages the loop variable.</td>
					</tr>
					<tr>
						<td>3</td>
						<td><a href="c_do.php">do...while loop</a></td>
						<td>It is more like a while statement, except that it tests the condition at the end of the loop body.</td>
					</tr>
					
					
				</table>
				<br>
				<h3><b>Loop Control Statements</b></h3>
				<br>
				<div class="holder2">
		
				<ul>
				<li>Loop control statements change execution from its normal sequence. When execution leaves a scope, all automatic objects that were created in that scope are destroyed.</li>
				<br>
				<li>C supports the following control statements.</li>
				<br>
				</ul>
				</div>
				<br>
				...
				<div class="but">
				<a href="c_switch.php" class="button prev">&laquo;prev</a>
				<a href="c_while.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
