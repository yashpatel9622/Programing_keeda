...
<body>
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="alphabet.jpg" alt="c programming label"> 
				<div class="but">
					<a href="prime.php" class="button prev">&laquo;prev</a>
					<a href="vowel.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
