...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>First Program</p></b></i></center></h1></div>	
				<div class="holder2">
					...
					<br>
					<br>
					<b>public</b> keyword is an access modifier which represents visibility,it means it is visible to all.
					<br>
					<br>
					<b>static</b> is a keyword, if we declare any method as static it is known as static method.the main method is executed by the JVM, it doesnt  require to create object to invoke the main method.so it saves memory.
					<br>
					<br>
					<b>void</b> is the return type of method, it means it doesnt return any value.
					<br>
					<br>
					<b>main</b> is a entry point of the program.Execution of programs starts from main.it is called by Runtime System.
					<br>
					<br>
					<b>String args[]</b>is used for command line argument. we will learn it later.
					<br>
					<br>
					<b>System.out.println()</b>is used print statement.s
						</ul>
				</div>
			<div class="but">
		
				<a href="java_intro.php" class="button next">prev &raquo;</a>
				<a href="java_var.php" class="button next">next &raquo;</a>
				</div>
</div>
