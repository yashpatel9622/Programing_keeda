...
<center style=font-size:25px;><h1 style=color:green;>  iostream</h1></center>
						<br>
						<hr>
						<br>
...
<p style=font-size:25px;> Standard Input-output Streams libary :Header thatdefines the standar input-output strea<br>
 objects:  note that the Stream class is mainely Declare the header<istream>.including <iostream><br>
 automatically include alo <iso>, <streambuf>,<isstream>,<osstream>, and <isofwd>.
