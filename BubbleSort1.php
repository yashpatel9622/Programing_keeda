	...
	void bubble_sort(long list[],long n)
	{
		...
		for(c=0;c< (n-1);c++)
		{
			for(d=0;d< n-c-1;d++)
			{
				...
				<br>
				<br>
				<img src="BubbleSortOP.png" alt="c programming label"> 
				<div class="but">
					<a href="BinarySearch1.php" class="button prev">&laquo;prev</a>
					<a href="InsertionSort1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
