	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Methods of an applet </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Methods of an applet<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>
<h2>public void init():</h2> is used to initialized the Applet. It is invoked only once.

<br><br><h2>public void start():</h2> is invoked after the init() method or browser is maximized.</br> It is used to start the Applet.
<br><br>
<h2>public void stop():</h2> is used to stop the Applet. ...
<br><br><h2>public void destroy():</h2> is used to destroy the Applet.
<br><br><h2>public void paint(Graphics g):</h2> is used to paint the Applet. It provides Graphics class object </br>that can be used for drawing oval, rectangle, arc etc.
