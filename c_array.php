	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<ul>
				<li>The array is a data structure in C programming, which can store a fixed-size sequential collection of elements of the same data type.</li>
				<br>
				<li>For example, if you want to store 10 numbers then instead of defining 10 variables it's easy to define an array of 10 lengths.</li>
				<br>
				</div>
<br>
...
<h5 style=color:red>Example</h5>
	...
	arr [1] [1] = 4;
				...
				<div class="but">
				<a href="c_lib.php" class="button prev">&laquo;prev</a>
				<a href="c_string.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
