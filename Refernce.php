...
<center style=font-size:25px;><h1 style=color:green;>C++ Refernce</h1></center>
						<br>
						<hr>
						<br>
...
C++ References. Advertisements. A reference variable is an alias, that is, another name<br>
 for an already existing variable. Once a reference is initialized with a variable, either<br>
 the variable name or the reference name may be used to refer to the variable.</p>
 <br>
<h1>References as Parameters</h1>
<br>
<p style=font-size:25px;>C++ supports passing references as function parameter more safely than parameters.</p>
<br>
<h1>	Reference as Return Value</h1>
<br>
<p style=font-size:25px;>You can return reference from a C++ function like any other data type.</p>
