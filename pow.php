...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>pow</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double pow(double base, double exponent);</div>
				<br>
	<h2>Raise to power</h2>
				<br>
				<div class="header2">
	...
	Floating point value.
				...
				<br>
	<h3>Return Value</h3>
	The return of raising base to the power exponent.
				<br>
				<br>
	If the magnitude of the result is so large that it cannot be represented in an object of the return type, a range error occurs, returning HUGE_VAL with the appropriate sign and setting the value of the global variable error to the ERANGE value.
				<br>
				<br>
