	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>mbstowcs</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">int mbstowcs(wchar_t *wcstr,const char *mbstr,size_t max);</div>
				<br>
	<h2>Convert multibyte string to wide-character string</h2>
				<br>
				<div class="header2">
