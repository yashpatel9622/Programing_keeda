...
<p> header</p>
<i>Description</i>
<p>Thread: Header that declares the thread class andthe this_thread namespace.


</p>
<table border="1" width="50%" height="300">
			
				<caption><h1>Members of Thread</h1></caption>
				<tr>
					<th>Option</th>
					<th>Description</th>
					</tr>
...
<td> std::thread </td>
<td>thread:classs to represent individual threads of execution</td>
</tr>
<tr>
<td>std::This_thread </td>
<td>This thread:this namespace groups a set </br> function that access the current thread </td>
</tr>
</table>
