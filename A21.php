	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Largest in array example</h1>
				<div class="cex">
					<pre>
						<code class="ccode" >
...
System.out.println("Largest: "+getLargest(b,7));  
				...
				<br>
				<br>
				<img src="i21.png" alt="c programming label"> 
				<div class="but">
				<a href="A20.php" class="button prev">&laquo;prev</a>
				<a href="A22.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
