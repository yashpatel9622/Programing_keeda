...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Sum of array using pointer</h1>
				<div class="PointerArraySum">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	void main()
	{
		...
		printf("The sum of array elements:%d",sum);
				...
				<br>
				<br>
				<img src="PointerArraySumOP.png" alt="c programming label"> 
				<div class="but">
					<a href="PointerReverse1.php" class="button prev">&laquo;prev</a>
					<a href="PointerLength1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
