...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Window status </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Window status<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
	...
	<p>
In addition to displaying information in its window, an applet can also output a messageto </br>the status window of the browser or applet viewer on which it is running. </br>To do so, callshowStatus( ) with the string that you want displayed. </br>The status window is a good placeto give the user feedback about what is occurring in the applet,</br> suggest options, or possiblyreport some types of errors. The status window also</br> makes an excellent debugging aid,because it gives you an easy way to output information about </br>your applet.The following applet demonstrates showStatus( ):
<br>
<br>
<h3>Using the Status Window</h3>
.import java.awt.*;
import java.applet.*;
 class StatusWindow extends Applet
 {
	 public void init()
	 {
