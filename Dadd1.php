...
<body>
	...
	int main()
	{
		...
		printf("Sum of digits of entered 
		number=%d\n",sum);
		...
		return 0;
				...
				<br>
				<br>
				<img src="DaddOP.png" alt="c programming label">
				<div class="but">
					<a href="Nadd1.php" class="button prev">&laquo;prev</a>
					<a href="GreaterNumber1.php" class="button next">next &raquo;</a>
				</div>			
			</div>
		</div>
		<div id="footer">
