...
#left-panel{width:23%;height:1120px;background-color:#eda150;float:left;padding:10px;}
.sidebar ul
{
list-style:none;
}
...
#right-section{width:73%;height:1120px;background-color:#bcc92b;float:right;padding:10px;}
.holder1{
color:brown;
font-size:40px;
}
...
<div id="right-section">
	<div class="holder1"><center>Contact Us</center></div>
	<br>
	<br>
<p style=font-size:24px>	We at ProgramminkKeeda deeply cherish your views regarding our website's performance. Whether it is doing it's job well, up to the mark or marvellously.
<br>
<br>
And for this we require your involvement, for any type of suggestion, question, complaint or something that you think is missing with us, or you have any new idea, Please feel free to contact us</p>
<p style=font-size:26px>Contact Us Please use below mail-id:</p>
<div class="holder3"><p style=font-size:24px>ProgramminkKeeda2019@gmail.com</center></p></div>
