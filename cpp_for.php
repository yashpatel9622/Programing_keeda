...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<p>for loop is used to execute a set of statement repeatedly until a particular condition is satisfied.We can say it an open ended loop.</p>
				<br>
	...
	for(initialization;condition;increment/decrement)
	{
		statement-block;
			...
			<div class="holder3">
					<ul>
						<li>In for loop we have exactly two semicolons, one after initialization and second after condition.In this loop we can have moew than one initialization or increment/decrement, separated using comma operator.for loop can have only one condition.</li>
					</ul>
			</div>
				<div class="example"><h4>Flowchart:</h4></div>
				<center><img src="flowchart-for-statement.png" alt="while-stat"></center> 
	...
	value of a: 19
			...
			<div class="but">
				<a href="cpp_do.php" class="button prev">&laquo;prev</a>
				<a href="cpp_func.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
