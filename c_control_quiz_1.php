...
<body>
  ...
  <h1 style=color:green;>Quiz : The Control of C - 1</h1>
  <br>
  <br>
  <ol class="quiz">
 <div class="q1">
    <li>
  <b>Que 1:What is the final value of x when the code int x;for(x=0;x<=100;x++){} is run;</b>
      <ul class="answers">
        <li><input type="radio" name="question-1" id="answer-1-1"><label for="answer-1-1">A. 100</label> </li>
        <li><input type="radio" name="question-1" id="answer-1-2"><label for="answer-1-2">B. 101</label></li>
        <li><input type="radio" name="question-1" id="answer-1-3"><label for="answer-1-3">C. 99</label></li>
        <li><input type="radio" name="question-1" id="answer-1-4"><label for="answer-1-4">D. None of these</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: labels uses to branch goto statement</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
<b>Que 3:  Which is not a loop structure in C language</b>
      <ul class="answers">
        <li><input type="radio" name="question-3" id="answer-3-1"><label for="answer-3-1">A. for</label></li>
        <li><input type="radio" name="question-3" id="answer-3-2"><label for="answer-3-2">B. foreach</label></li>
        <li><input type="radio" name="question-3" id="answer-3-3"><label for="answer-3-3">C. do while</label></li>
        <li><input type="radio" name="question-3" id="answer-3-4"><label for="answer-3-4">D. while</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b> Que 4:Continue statement can't skips the rest of current iteration of the loop and returns to starting point of the loop.</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 5: When does the code block following while(x<10) execute?</b>
      <ul class="answers">
        <li><input type="radio" name="question-5" id="answer-5-1"><label for="answer-5-1">A. When x is less than 10</label></li>
        <li><input type="radio" name="question-5" id="answer-5-2"><label for="answer-5-2">B. When x is greater than 10</label></li>
        <li><input type="radio" name="question-5" id="answer-5-3"><label for="answer-5-3">C. When x is less than and equal to 10</label></li>
        <li><input type="radio" name="question-5" id="answer-5-4"><label for="answer-5-4">D. When x is equal to 10</label></li>
	   </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: Which is not suitable to while loop</b>
      <ul class="answers">
        <li><input type="radio" name="question-6" id="answer-6-1"><label for="answer-6-1">A. while loop guaranteed to loop one time</label></li>
        <li><input type="radio" name="question-6" id="answer-6-2"><label for="answer-6-2">B. The statements within the while keep on getting executed till the condition being tested remains true</label></li>
        <li><input type="radio" name="question-6" id="answer-6-3"><label for="answer-6-3">C. While loop easy to use over for loop</label></li>
        <li><input type="radio" name="question-6" id="answer-6-4"><label for="answer-6-4">D. While loop uses only in file handling</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
 	 <div class="q1">
    <li>
<b>Que 7: By uses of goto, programs becomes unreliable, unreadable, and hard to debug.</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8:The while and for loops test the termination condition at the top. But the do-while, tests at the bottom after making each pass through the loop body.</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
  <b>Que 9:Each pass through a loop is called a/an</b>
      <ul class="answers">
        <li><input type="radio" name="question-9" id="answer-9-1"><label for="answer-9-1">A. loop</label></li>
        <li><input type="radio" name="question-9" id="answer-9-2"><label for="answer-9-2">B. pass</label></li>
        <li><input type="radio" name="question-9" id="answer-9-3"><label for="answer-9-3">C. iteration</label></li>
        <li><input type="radio" name="question-9" id="answer-9-4"><label for="answer-9-4">D. None of these</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
   <b>Que 10:Loops can repeat a part of a program</b>
      <ul class="answers">
