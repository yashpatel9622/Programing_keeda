	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>memchr</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">void *memchr(const void *buffer,int value,size_t count);</div>
				<br>
	<h2>Locate character in block of memory</h2>
				<br>
				<div class="header2">
	Searches within the first num bytes of the block of memory pointed by buffer for the first occurrence of value (interpreted as an unsigned char), and returns a pointer to it.
				<br>
				<br>
	<h3>Parameters</h3>
	buffer	
