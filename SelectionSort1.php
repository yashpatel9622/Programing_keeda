...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="SelectionSortOP.png" alt="c programming label"> 
				<div class="but">
					<a href="InsertionSort1.php" class="button prev">&laquo;prev</a>
					<a href="PrintString1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
