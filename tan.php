...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>tan</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double tan(double x);</div>
				<br>
	<h2>Compute tangent</h2>
				<br>
				<div class="header2">
	...
	x
				<br>
	Floating point values representing an angle expressed in radians.
				<br>
				<br>
	<h3>Return Value</h3>
	Tangent of x.
