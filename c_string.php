	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<ul>
				<li>C Strings are nothing but array of characters ended with null character (‘\0’). </li>
				<br>
...
<div class="holder3">
				...
				<ul>
				<li>char string[20] = {‘d’, ’i’, ‘p’, ‘l’, ‘o’, ‘m’, ‘a’, ‘l’, ‘a’, ’n’, ‘g’, ‘\0’}; </li>
				<br>
				<li>char string[20] = “diplomalang”;</li>
				<br>
				<li>char string []    = “diplomalang”;</li>
				<br>
...
<table style="width:100%">
				...
				<div class="but">
				<a href="c_array.php" class="button prev">&laquo;prev</a>
				<a href="c_pointer.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
