...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>isprint</p></b></i></center></h1>
				<br>
				<hr>
				<br>
			<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int isprint(int c);</div>
				<br>
	<h2>Check if character is printable</h2>
				<br>
				<div class="header2">
	...
	plus 0x7f(DEL).Therefore,printable characters are all but these,although specific compiler implementations for certain 
	platforms may define additional control characters in the extended character set(above 0x7f).
				<br>
				<br>
	isgraph returns true for the same cases as isprint except for the whitespace characters (like ''), which return
