...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>atan</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double atan(double x);</div>
				<br>
	<h2>Compute arc tangent</h2>
				<br>
				<div class="header2">
	...
	In trigonometrics, arc tangent is the inverse operation of tangent.
				<br>
				<br>
	Notice that because of the sign ambiguity, a function cannot determine with certainly in which quadrant the angle falls only by its tangent value. You can use atan2 if you need to determine the quadrant.
				<br>
				<br>
	<h3>Parameters</h3>
	x
