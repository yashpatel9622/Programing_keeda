	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Encapsulation</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Encapsulation</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>Encapsulation is one of the four fundamental OOP concepts. The other three are inheritance, </br>polymorphism, and abstraction. Encapsulation in Java is a mechanism of wrapping </br>the data (variables) and code acting on the data (methods) together as a single unit. ... </br>Declare the variables of a class as private.
...
<br>
<br>
<h3>To achieve encapsulation in Java −
</h3>
<p>
