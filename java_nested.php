...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>Nested If-else Statement</p></b></i></center></h1></div>	
				<div class="holder2">
				
					<ul>
					<b>Nested if..else:</b>when a series of decisions are involved,we may have to use more than one if..else statement in nested from as follows:
					<br>
					<br>Syntax:</b><br>
					if(condition1)
						<br>
			...
			<div class="but">
				...
				<a href="java_ifelse.php" class="button next">prev &raquo;</a>
				<a href="java_switch.php" class="button next">next &raquo;</a>
				</div>
</div>
