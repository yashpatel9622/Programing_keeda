...
<body>
	...
	int main()
	{
		...
		if(n<0)
			printf("Negative integers are not 
			allowed.\n");
		else
		{
			f=factorial(n);
	...
	long factorial(int n)
	{
		...
		return(n*factorial(n-1));
				...
				<div class="but">
					<a href="FactFunction1.php" class="button prev">&laquo;prev</a>
					<a href="FibonacciLoop1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
