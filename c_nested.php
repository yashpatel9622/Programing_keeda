...
#left-panel{width:22%;height:2430px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2410px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Nested If-else Statements</p></b></i></center></h1></div>
				<p>The if...else statement executes two different codes depending upon whether the test expression is true or false. Sometimes, a choice has to be made from more than 2 possibilities.</p>
				<br>
				<p>The nested if...else statement allows you to check for multiple test expressions and execute different codes for more than two conditions.</p>
				<br>
				<div class="example"><h4>Syntax:</h4></div>
				<br>
				<p>The syntax of an Nested if...else statement in C programming language is −</p>
				<div class="holder2">
				<pre><code>
	...
	else 
	{
		// statements to be executed if all test expressions are false
				...
				<div class="holder3">
					<ul>
						<li>If the test expression1 evaluates to false, then test Expression 2 is checked and statements are executed if it is true.If test Expression 2 also gets failure,then else part is executed.</li>
				...
				<center><img src="flowchart-nested-if-else-statement.png" alt="nested-if-else-stat"></center> 
...
<div class="but">
				<a href="c_ifelse.php" class="button prev">&laquo;prev</a>
				<a href="c_elseif.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
