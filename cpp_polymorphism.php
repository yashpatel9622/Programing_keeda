...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Polymorphism</p></b></i></center></h1></div>
				<br>
				<p>Polymorphism actually means 'one with many forms'. In C++, we can use same names of functions to do different works depending on their return type and their arguments.</p>
				<br>
				<p>There are two types of polymorphism as</p>
				<br>
				<pre>
	...
	2.Function Overriding
				...
				<br>
				<div class="holder3">
				<h3 style=color:red>Function Overloading</h3>
				<br>
				<p>If any class have multiple functions with same names but different parameters then they are said to be overloaded.Function overloading allows us to use the same name for different functions,to perform, either same or different functions in the same class.</p>
				<br>
				<p>Functions are overloading depends on the total number and types of arguments present for the function.</p>
				<br>
	...
	void sum(int i,float j)
	{
		....
					...
					<p>There are three functions with same name ('sum') are present in the above example.These three have same name but can have different definition.This is called as the function overloading.The call of function depends on the parameter passing. If we pass 3 int values to 'sum' function, the second in the above example will be called and if we pass one int and one float value, third will be called.</p>
					<br>
				
				<div class="holder3">
				<h3 style=color:red>Function Overriding</h3>
				<br>
				<p>In function overriding deals with the inherited classes.If there are two or more than two functions with same name, same return type and same argument (i.e. exact same function) is present in base and its derived class, then it is called as function overriding.</p>
				<br>
				<p>The overriding functions can have different definitions.The function belonging to the object's parent class will be caleed.</p>
				<br>
				<p>We can call both functions using object of derived class as:</p>
				<br>
	
	<p>1.To call overriding function in derived class-
		derived_class_object.function_name();
	2.To call overriding function in base class through derived class's object-
	derived_class_object.base_class::function_name();</p>
				</div>
				
				<div class="but">
				<a href="cpp_inheritance.php" class="button prev">&laquo;prev</a>
				</div>
				</div>
		</div>
		<div id="footer">
