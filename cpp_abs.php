...
<i>Description</i>
<p>
Computer asolute value: return the absolute value of X:|X|.</br> these convenience abs overloads are exclusive of C++. In C,abs is </br>only
declared in <stdlib>. Since C ++1,additions overloads are provided</br> in this header <cmath> for the integral types: These overloads effectively </br>cast X to a double before calculation


</p>
<i>prototype</i>
<b> double  abs (double X); float abs (float X); long abs (long X)</b>
<i>parameters</i>
<p>
parameters X value whose absolute value is returned.
</P>
<i>return valus</i>
<p>
absolute value of x.
