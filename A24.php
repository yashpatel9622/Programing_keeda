...
System.out.println();//new line    
				...
				<br>
				<br>
				<img src="i24.png" alt="c programming label"> 
				<div class="but">
				<a href="A23.php" class="button prev">&laquo;prev</a>
				<a href="A25.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
