...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<br>
				<p>Functions are used to provide modularity to a program.Creating an application using function makes it easier to understand,edit,check errors,etc.</p>
				<br>
				<h4 style=color:green>Syntax of Function</h4>
				<br>
				<pre>
	return_type function_name(parameters)
	{
		//function-body
				...
				<h4 style=color:green>return_type:</h4>
				<p>Suggests what the funcion will return.It can be int,char,some pointer or even a class object.There can be functions which does not return anything, they are mentioned with void.</p>
				<br>
				<h4 style=color:green>function_name:</h4>
				<p>Is the name of the function, using the function name it is called.</p>
				<br>
				<h4 style=color:green>Parameters:</h4>
				<p>Are variables to hold values of arguments passed while function is called.A function may or may not contain parameter list.</p>
				<pre>
	...
	int main()
	{
		...
		sum(a,b);
				...
				<br>
				<p>Here, a and b are sent as arguments,and x and y are parameters which will hold values of a and b to perform required operation inside function.</p>
				<br>
				<h4 style=color:green>function-body</h4>
				<p>Is the part where the code statements are written.</p>
				
				
				
				<div class="but">
				<a href="cpp_for.php" class="button prev">&laquo;prev</a>
				<a href="cpp_defdec.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
