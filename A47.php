...
v.addElement(new Double(7.16));
v.addElement(new Double(5.13));
...
System.out.println("element;"+e.nextElement());
				...
				<br>
				<br>
				<img src="P48.png" alt="c programming label"> 
				<div class="but">
				<a href="A48.php" class="button prev">&laquo;prev</a>
				<a href="A46.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
