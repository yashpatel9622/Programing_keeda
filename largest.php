...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Find Largest of Two Numbers</h1>
				<div class="Structure">
					<pre>
						<code class="ccode" >
	...
	void main()
	{
		...
		cout<<"Biggest of the two number is"
		<< big;
		getch();
	}
						</code>
				...
				<br>
				<br>
				<img src="largest.jpg" alt="c programming label"> 
				<div class="but">
					<a href="count.php" class="button prev">&laquo;prev</a>
				</div>
			</div>
		</div>
		<div id="footer">
