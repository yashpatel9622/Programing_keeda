	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Function Basics</p></b></i></center></h1></div>	
				<h4 style=color:green>Building Blocks of Programs</h4>
				<br>
				<p>Functions like main, printf and scanf, We have already come through. All C programs made up of one or more functions. There must be one and only one main function. All functions are at the same level -there is no nesting.</p>
				<br>
				<h4 style=color:green>Return Value</h4>
				<br>
				<p>Including main All functions can return a value, Void Return type is specified if function is returning no value. Functions can return arithmetic values (int, float etc.), pointers structures, unions, or will not return anything (void) But they cannot return an array or a function.</p>
				<br>
				<h4 style=color:green>Function Parameters</h4>
				<br>
				<div class="holder3">
		
				<ul>
				<li>Any function (as well as main) can receive some values called parameters. While calling a function we must pass values of parameters.</li>
				<br>
				<li>Format of Function:-
				<br>< return_type>
				function_name>(parameters..)
				{
				}</li>
				<br>
				<li>Only Values of the parameters to the function at the time of calling it</li>
				<br>
				<li>If, In definition of function contains void as parameter then function will not accept any parameter.</li>
				<br>
				<li>Calling the expressions specified as arguments in a function call and the variables listed as parameters in the function definition is very usual. For example, in the following call of function, the expressions x and y*2 are the arguments passed to the function. The values of the xand y will be copied into the parameters p and q. The variable given in the functiondefinition are called as formal argument and the expression given in the function call are called as the actual argument.</li>
				<br>
				</li>cal_area(a, b*2);</li>
				...
				<div class="but">
				<a href="c_for.php" class="button prev">&laquo;prev</a>
				<a href="c_defdec.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
