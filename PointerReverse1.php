	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Reverse array using pointer</h1>
				<div class="PointerReverse">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	#define MAX 30
	void main()
	{
		...
		for(i=size-1;i>=0;i--)
		{
			...
			ptr--;
				...
				<br>
				<br>
				<img src="PointerReverseOP.png" alt="c programming label"> 
				<div class="but">
					<a href="PointerAddition1.php" class="button prev">&laquo;prev</a>
					<a href="PointerArraySum1.php" class="button next">next &raquo;</a>
				</div>	
			</div>
		</div>
		<div id="footer">
