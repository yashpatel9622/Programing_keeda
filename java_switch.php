...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>Switch Statement</p></b></i></center></h1></div>	
				<div class="holder2">
				
					<ul>
					<b> Switch Statement:</b> this is a easier implementation if if else.the keyword "switch" is followed by an expession that should evaluate to byte,short.char or int primitive data types only  on a switch block there  can be one or more labeled cases.
					<br>
			...
			<div class="but">
				...
				<a href="java_nested.php" class="button next">prev &raquo;</a>
				<a href="java_while.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
<div id="footer">
