...
<body>
	...
	void  main()
	{
		...
		decimal_val);
				...
				<br>
				<br>
				<img src="BinaryToDecimalOP.png" alt="c programming label"> 
				<div class="but">
					<a href="DecimalToOctal1.php" class="button prev">&laquo;prev</a>
					<a href="BinaryToOctal1.php" class="button next">next &raquo;</a>
				</div>	
			</div>
		</div>
		<div id="footer">
