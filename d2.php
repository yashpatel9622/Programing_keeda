	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<center style=font-size:25px;><h1 style=color:green;>bitset</h1></center>
			<br>
			<hr>
			<br>
...
<p style=font-size:25px;>
 Bitset header:Header that define the bitset class.
</p>
...
<tr>
<td> std::bitset::bitset</td>
<td>construct the bitset container object</td>
</tr>
<tr>

<td> std::bitset::operator</td>
<td>perform the proper bitwise operation</br> using thecontents of the bitwise</td>
</tr>

<tr>
<td> std::bitset::refernce</td>
<td>refernce like type</td>


</tr>

<tr>
<td> std::bitset::all</td>
<td> test if all bit are set</td>


</tr>

<tr>
<td> std::bitset::any</td>
<td> test if any bit is set</td>

</tr>

<tr>
<td> std::bitset::count</td>
<td>count bit set</td>

</tr>

<tr>
<td> std::bitset::flip</td>
<td>flips bit values converting zero into </br>once and once into zaro</td>

</tr>

<tr>
<td> std::bitset::none</td>
<td>test if bit is set</td>
...
<tr>
<td> std::bitset::reset</td>
<td> reset if bit is no set</td>

</tr>

<tr>
<td> std::bitset::set</td>
<td>sets bit</td>

</tr>

<tr>
<td> std::bitset::size</td>
<td>return size</td>

</tr>

<tr>
<td> std::bitset::to_string</td>
<td>convert to String</td>

</tr>

<tr>
<td> std::bitset::to_ullong</td>
<td> convert to unsigned long long </td>

</tr>

<tr>
<td> std::bitset::to_ulong</td>
...
<tr>
<td> std::bitset::hash_bitset</td>
<td>hash for bitset</td>
