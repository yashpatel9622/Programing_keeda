...
<li><a href="java_file_manag_quiz_1.php">Java File Management 1</a></li>
  ...
  <h1 style=color:green;>Quiz : Java Loop</h1>
  <br>
  <br>
  <ol class="quiz">
  <div class="q1">
    <li>
  <b>Que 1:looping statement in java________?</b>
      <ul class="answers">
        <li><input type="radio" name="question-1" id="answer-1-1"><label for="answer-1-1">A.if-else</label> </li>
        <li><input type="radio" name="question-1" id="answer-1-2"><label for="answer-1-2">B. for loop</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: looping statement in java?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
	...
	<br>
	 <div class="q1">
    <li>
<b>Que 3: if(conditoon)
{
// block of statement
} this syntax are which loop?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. if-else</label></li>
       </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b> Que 4:  which loop is a nothing  but series of decision?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 5:  when multi path decision are used ____ looping are use?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: which of these statement are used to multi way selection?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D.switch case statement</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 7:_______  loop repeats a group of statement as long as the conditon is true?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8: which  of these loop are used to repeated execution of statement?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
	...
	<br>
	 <div class="q1">
    <li>
  <b>Que 9:which looping statement are used to terminate  the execution? </b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. beack statement</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. All of these</label></li>
       </ul>
    </li>
	</div>
	...
	<br>
	 <div class="q1">
    <li>
   <b>Que 10:_______ loop are used to skip execution of current loop and start the execution of next loop?</b>
      <ul class="answers">
         <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. nested if-else </label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B.  if-else ladder</label></li>
        <li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. while loop</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D.continue statement</label></li>
      </ul>
    </li>
	<div>
  </ol>
