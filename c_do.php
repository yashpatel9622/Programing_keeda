...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<p>A do...while loop is similar to a while loop, except the fact that it is guaranteed to execute at least one time.</p>
				<br>
				<div class="example"><h4>Syntax:</h4></div>
				<br>
				<p>The syntax of an do....while loop in C programming language is −</p>
				<div class="holder2">
				<pre><code>
	do
	{
	...
	while( condition );
				...
				<div class="holder3">
					<ul>
						<li>Notice that the conditional expression appears at the end of the loop, so the statement(s) in the loop executes once before the condition is tested.</li>
						<li>If the condition is true, the flow of control jumps back up to do, and the statement(s) in the loop executes again. This process repeats until the given condition becomes false.</li>
					</ul>
				</div>
				<div class="example"><h4>Flowchart:</h4></div>
				<center><img src="flowchart-do-statement.png" alt="do-stat"></center> 
	...
	value of a: 19
				...
				<div class="but">
					<a href="c_while.php" class="button prev">&laquo;prev</a>
					<a href="c_for.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
