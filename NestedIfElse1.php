	...
	void main()
	{
		...
		if(marks>100)
			...
			printf("your grade is E");
				...
				<br>
				<br>
				<img src="NestedIfElseOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Swapping1.php" class="button prev">&laquo;prev</a>
					<a href="Percentage1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
