...
<i>Description</i>
<p>
check if character is graphical representation: checks whether c is a character with</br> graphical representation. the characters with graphical representation are all those character
 than can be printed expect the character(''). For a detailed chart on what the different</br> ctype functions return 
for each character of the standard ASCII character set,see the refernce </br>for the <ctype> header. In C++ , a locale-specified template version of this function(isgraph)
exists in header <locale>.

</p>
<i>prototype</i>
<b>int isgraph (int c);</b>
<i>parameters</i>
<p>
