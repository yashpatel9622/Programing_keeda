...
#left-panel{width:22%;height:2320px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2300px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:25px;
}
...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Inline and Friend Function</p></b></i></center></h1></div>	
				
				<div class="holder3">
					<h3 style=color:black>Inline Function</h3>
					<br>
					<ul>
						<li>When a small function is needed for repeated times,it time consuming to call it every time from the memory in the code.For uch conditions, inline function is used.</li>
						<br>
						<li>The inline function actually puts the whole function block at the time of compilation in the code while the regular function transfers the flow to the memory lication of the function code at the time of program running.</li>
						<br>
					</ul>
				</div>
	...
	inline int mult(int x)
	{
		return (x*2);
					...
					<div class="holder3">
					<li>For inline function, the keyword "inline" is used before function name and return type.When the function is needed, it is called as the regular function calling.But the inline function, instead of transfering the flow, literally paste the function code at the space of call.<li>
					<br>
					<li>The inline function saves the time of running and compilation but it increases the size of the program.</li>
					<br>
					</div>
					<div class="holder3">
					<h3 style=color:black>Friend Function</h3>
					<br>
					<ul>
						<li>A friend function of a class is defined outside that class scope but it has the right to access all private and protected members of the class.Even though the prototypes for friend functions appear in the class definition, friends are not member functions. </li>
						<br>
						<li>A friend can be function, function template, or member function, or a class or class template, in which case the entire class and all of its members are friends.</li>
						<br>
						<li>To declare a function as a friend of a class, precede the function prototype in the class definition with keyword friend as follows:</li>
						<br>
					</ul>
				</div>
					<h5 style=color:red>Example</h5>
	...
	class ABC
	{
		...
		public:
			...
			void setWidth(double c)
					...
					<div class="holder3">
					<ul>
						<li>To declare all member functions of the class XYZ as friends of class ABC, place a following declaration of class ABC:</li>
						<br>
						<p>friend class XYZ</p>
					</ul>
					<br>
					</div>
				<div class="but">
				<a href="cpp_defdec.php" class="button prev">&laquo;prev</a>
				<a href="cpp_array.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
