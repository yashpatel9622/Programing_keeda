	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>import keywords</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>import keywords</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>

			<p>It declares a Java class to use in the code below the import statement.</br> Once a Java class is declared, then the class name can be used in the</br> code without specifying the package the class belongs to. </br>Use the '*' character to declare all the classes belonging to the package.
</p>
<br>
<br>
