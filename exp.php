...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>exp</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double exp(double x);</div>
				<br>
	<h2>Compute exponential function</h2>
				<br>
				<div class="header2">
	...
	Exponential value of x.
				<br>
	If the magnitude of result is so large that it cannot be represented in an object of the return type, the function returns HUGE_VAL, and the value of the global variable errorno is set to the ERANGE value.
				</div>
