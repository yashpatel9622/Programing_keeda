...
<body>
	...
	int main()
	{
		...
		printf("Enter a year to check if it is 
		a leap year\n");
		scanf("%d",&year);
		...
		return 0;
				...
				<br>
				<br>
				<img src="LeapYearOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Vowel1.php" class="button prev">&laquo;prev</a>
					<a href="Reverse1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
