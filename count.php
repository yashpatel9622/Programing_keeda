...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Count Occurrence of Numbers</h1>
				<div class="Structure">
					<pre>
						<code class="ccode" >
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="count.jpg" alt="c programming label"> 
				<div class="but">
					<a href="swap.php" class="button prev">&laquo;prev</a>
					<a href="largest.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
