...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="ArmstrongOP.png" alt="c programming label"> 
				<div class="but">
					<a href="perfect1.php" class="button prev">&laquo;prev</a>
					<a href="GenerateArmstrong1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
