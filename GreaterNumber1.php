	...
	int main()
	{
		...
		if(a>b&&a>c)
			...
			printf("greatest number is:%d",c);
				...
				<br>
				<br>
				<img src="GreaterOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Dadd1.php" class="button prev">&laquo;prev</a>
					<a href="Swapping1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
