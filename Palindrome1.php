...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="PalindromeOP.png" alt="c programming label"> 
				<div class="but">
					<a href="ReverseArray1.php" class="button prev">&laquo;prev</a>
					<a href="prime1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
