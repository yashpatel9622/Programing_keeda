...
<center style=font-size:25px;><h1 style=color:green;> std::resetiosflags</h1></center>
						<br>
						<hr>
						<br>
...
Reset format flags: Unsets the format flags specified by parameter mask. Behaves as if<br>
 they were unsetf were called with mask as argument on the stream on which it is inserted<br>
 / extracted as a manipulator (it can be inserted / extracted on input streams or output<br>
 streams). See the base: fmtflags for more information on the particular flags that can <br>
 be modified with this manipulator function. This manipulator is declared in header Kiomanip </p>
 <br>
<h2>prototype</h2>
<br>
<b style=font-size:25px>   Prototype / * unspecified * / resetiosflags (ios base: fmtflags mask);    </b>
<br>
<h2>parameters</h2>
<br>
<p style=font-size:25px>
  Parameters mask Mask representing the flags to be reset. fmtflags is a bitmask type. 
</p>
<br>
