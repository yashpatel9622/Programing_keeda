...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="PrintStringOP.png" alt="c programming label"> 
				<div class="but">
					<a href="SelectionSort1.php" class="button prev">&laquo;prev</a>
					<a href="StringLength1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
