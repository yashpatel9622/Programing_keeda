...
<body>
	...
	void main()
	{
		...
		printf("Area of a circle=%5.2f\n",area);
				...
				<br>
				<br>
				<img src="CircleAreaOP.png" alt="c programming label"> 
				<div class="but">
					<a href="SimpleInterest1.php" class="button prev">&laquo;prev</a>
					<a href="RectangleArea1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
