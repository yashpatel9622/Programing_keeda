	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>va_end</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdarg.h></h2></div>
				<div class="header1">void va_end(va_list ap);</div>
				<br>
	<h2>End using variable argument list</h2>
				<br>
				<div class="header2">
	Performs the appropriate actions to facilitate a normal return by a function that used the va_list object ap to retrieve its additional arguments.
				<br>
				<br>
