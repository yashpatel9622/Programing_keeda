...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="ReverseOP.png" alt="c programming label"> 
				<div class="but">
					<a href="LeapYear1.php" class="button prev">&laquo;prev</a>
					<a href="ReverseArray1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
