...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>memcmp</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">int memcmp(const void *buffer1,const void *buffer2,size_t count);</div>
				<br>
	<h2>Compare two blocks of memory</h2>
				<br>
				<div class="header2">
	Compares the first num bytes of the block of memory pointed by buffer1 to the first num bytes pointed by buffer2, returning zero if they all match or a value different from zero representing which is greater if they do not.
				<br>
				<br>
	<h3>Parameters</h3>
	buffer1
	...
	A zero value indicates that the contents of both memory blocks are equal.
				<br>
	A value greater than zero indicates that the first byte that does not match in both memory blocks has a greater value in buffer1 than in buffer2 as if evaluated as unsigned char values; And a value less than zero indicates the opposite.
				</div>
