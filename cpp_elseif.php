...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>else-if Statements</p></b></i></center></h1></div>
				<p>else-if statements in C++ is like another if condition, it's used in a program when if statement having multiple decisions.</p>
				<br>
				<div class="example"><h4>Syntax:</h4></div>
				<br>
				<p>The syntax of an else-if statement in C++ programming language is −</p>
				<div class="holder2">
				<pre><code>
	...
	else
	{
		//execute your code
				...
				<div class="holder3">
					<ul>
						<li>If the test expression evaluates to false, then test Expression n is checked and statements are executed if it is true.If test Expression n also gets failure,then else part is executed.</li>
				...
				<center><img src="flowchart-else-if-statement.png" alt="else-if-stat"></center> 
	...
	divisible by 5
			...
			<div class="but">
				<a href="cpp_nested.php" class="button prev">&laquo;prev</a>
				<a href="cpp_switch.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
