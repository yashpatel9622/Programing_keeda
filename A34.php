...
obj.print();  
				...
				<br>
				<br>
				<img src="i34.png" alt="c programming label"> 
				<div class="but">
				<a href="A33.php" class="button prev">&laquo;prev</a>
				<a href="A35.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
