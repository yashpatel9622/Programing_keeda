...
<div id="right-section">
				...
				<div class="holder2">
					...
					<ul>
					<b>Do while loop:</b> this is another looping statement that tests the given condition past so you can say that the do-while looping statement is a pass test statement.
				<br>
				    Syntax: do
					<br>
					        {
			...
			<div class="but">
				...
				<a href="java_while.php" class="button next">prev &raquo;</a>
				<a href="java_for.php" class="button next">next &raquo;</a>
				</div>
</div>
