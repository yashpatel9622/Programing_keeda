	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>putchar</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int putchar(int char);</div>
				<br>
	<h2>Write character to stdout</h2>
				<br>
				<div class="header2">
	Writes char to the current position in the standard output (stdout) and advances the internal file position indicator to the next position.
				<br>
				<br>
