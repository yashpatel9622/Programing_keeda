...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>fflush</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int fflush(FILE *stream);</div>
				<br>
	<h2>Flush stream </h2>
				<br>
				<div class="header2">
	If the given stream was open for writing and the last i/o operation was an output operation, any unwritten data in the output buffer is written to the file 
				<br>
	If it was open for reading and the last operation was an input operation, the behaviour depends on the specific library implementation. In some implementation this cause the input buffer to be cleared, but this is not standard behaviour.
				<br>
	If the argument is null pointer, all open files are flushed.
				<br>
