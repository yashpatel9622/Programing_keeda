	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>standard header files </p></b></i></center></h1></div>	
				
				<div class="holder2">
				<p>standard header files contains Prototypes of the library functions. For example, math.h contains prototypes for mathematical operations.</p>
				<br>
				<ul>
				<li>some standard header files are:
				<br>
					<ol>
						<li><b>stdio.h</b> printf, scanf, getchar, putchat etc.</li>
						<li><b>stdlib.h</b> utility functions; number conversions, memory allocation, exit and system , Quick Sort</li>
						<li><b>float.h</b> system limits for floating point types</li>
						<li><b>math.h</b> mathematical functions</li>
						<li><b>string.h</b> string functions</li>
						<li><b>assert.h</b> assertions</li>
						<li><b>ctype.h</b> character class tests</li>
						<li><b>time.h</b> date and time functions</li>
						<li><b>limits.h</b> system limits for integral types</li>
						<li><b>setjmp.h</b> non-local jumps</li>
						<li><b>signal.h</b> signals and error handling</li>
						<li><b>stdarg.h</b> variable length parameter lists</li>
					</ol>
				</li>
				</ul>
				<br>
				<p>Use the #include (preprocessor directive) and give angle brackets around the name of the file to include these standard header files in your program </p>
				
				</div>
				
				<div class="but">
				<a href="c_operator.php" class="button prev">&laquo;prev</a>
				<a href="c_decision.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
