...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Print Floyd's Triangle</h1>
				<div class="FloydsTriangle">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="FloydsTriangleOP.png" alt="c programming label"> 
				<div class="but">
					<a href="DiamondPattern1.php" class="button prev">&laquo;prev</a>
					<a href="PascalTriangle1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
