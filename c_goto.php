...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>goto Statements</p></b></i></center></h1></div>
				<p>A goto statement in C programming provides an unconditional jump from the 'goto' to a labeled statement in the same function.</p>
				<br>
				<div class="example"><h4>Syntax:</h4></div>
				<br>
				<p>The syntax of an goto statement in C programming language is −</p>
				<div class="holder2">
				<pre><code>
	goto label;
	..
	...
	label: statement;
				...
				<div class="holder3">
					<ul>
						<li>Here label can be any plain text except C keyword and it can be set anywhere in the C program above or below to goto statement.</li>
					</ul>
				</div>
				<div class="example"><h4>Flowchart:</h4></div>
				<center><img src="flowchart-goto-statement.png" alt="goto-stat"></center> 
...
<div class="but">
				<a href="c_elseif.php" class="button prev">&laquo;prev</a>
				<a href="c_switch.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
