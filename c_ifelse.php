...
<body>
	...
	else 
	{
		/* statement(s) will execute if the boolean expression is false */
				...
				<div class="holder3">
					<ul>
						<li>If the Boolean expression evaluates to true, then the if block will be executed, otherwise, the else block will be executed.</li>
...
<div class="but">
				<a href="c_if.php" class="button prev">&laquo;prev</a>
				<a href="c_nested.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
