...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>sinh</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double sinh(double x);</div>
				<br>
	<h2>Compute hyperbolic sine</h2>
				<br>
				<div class="header2">
	...
	Hyperbolic sine of x.
				<br>
	If the magnitude of the result is so large that it cannot be representd in an object of the return type, the function returns HUGE_VAL with the same sign as the correct value of the operation, and the value of the global variable errno is set to the ERANGE value.
				</div>
