	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>fread</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">size_t fread(void *buffer, size_t size,size_t count,FILE *stream);</div>
				<br>
	<h2>Read block of data from stream</h2>
				<br>
				<div class="header2">
	Reads an array of count elements, each one with a size of size bytes, from the stream and stores them in the block of memory specified by buffer.
				<br>
				<br>
