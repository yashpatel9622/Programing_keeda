...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>mbtowc</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdlib.h></h2></div>
				<div class="header1">int mbtowc(wchar_t *pwc,const char *pmb,size_t max);</div>
				<br>
	<h2>Convert multibyte character to wide character</h2>
				<br>
				<div class="header2">
	...
	Maximum number of bytes to be checked for character length. No more than MB_CUR_MAX characters are examined in any case.
				...
				<br>
	<h3>Return Value</h3>
	If the argument passed as pmb is not a null pointer, the size in bytes of the character pointed by pmb is returned when it forms a valid multibyte character and is not the terminating null character. 
				<br>
	If it is the terminating null character, the function returns zero, and in the case they do not form a valid multibyte character, -1 is returned.
				<br>
