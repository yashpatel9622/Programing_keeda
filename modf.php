...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>modf</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double modf(double x, double *intpart);</div>
				<br>
	<h2>Break into fractional and integral parts</h2>
				<br>
				<div class="header2">
	...
	intpart
				<br>
	Pointed to an object where the integral parts is to be stored.
				<br>
				<br>
	<h3>Return Value</h3>
