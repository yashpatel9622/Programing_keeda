	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Reading from a file</p></b></i></center></h1></div>	
				<br>

				<h4>Read from a text file using fscanf()</h4>
...
<br>
<p>This program reads the integer present in the program.txt file and prints it onto the screen.</p>
<br>
<p>If you succesfully created the file from Example 1, running this program will get you the integer you entered.</p>
<br>
<p>Other functions like fgetchar(), fputc() etc. can be used in similar way.</p>
<br>

				<div class="but">
				<a href="c_write_to_file.php" class="button prev">&laquo;prev</a>
				</div>
			</div>
		</div>
		<div id="footer">
