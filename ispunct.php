	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>ispunct</p></b></i></center></h1>
				<br>
				<hr>
				<br>
			<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int ispunct(int c);</div>
				<br>
	<h2>Check if character is a punctuation character</h2>
				<br>
				<div class="header2">
	Checks if parameter c is a punctuation character.For the purpose of this function, a punctuation character is
	any graphic character (as in isgraph) that is not alphanumeric (as in isalnum).
				<br>
				<br>
	<h3>Parameters</h3>
	c
