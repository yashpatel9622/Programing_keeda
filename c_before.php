...
#left-panel{width:22%;height:2520px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2500px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Before C</p></b></i></center></h1></div>	
				<div class="holder2">
					<h2><b>Run C program on Windows</b></h2>
				</div>
				<div class="holder3">
				<p>
				<ul>
				<li> Windows In Windows, C program can be easily executed using IDE (Integrate Development Environment). Various IDEs are available for the platform Most popular being the CodeBlocks, DevBlock, TurboC. </li>
				<br>
				<li>Write The C Program then execute build and run the program to get the output</li>
				
				</ul>

				</div>
				<center><img src="windows_c.jpg" alt="windows_c"></center>
				<div class="holder4"><h1><b>Run C program on Linux</b></h1></div>
				<div class="holder5">				
				<p>Ubuntu is one of the most popular operating system for programming because there are lot of great open source applications, tools, compilers, debuggers, IDEs are available free of cost. Some of them are GCC The greatest compiler Software Foundation by Stallman) </p>
				<br>
				<p>To run C Programm in Linux follow these steps: </p>
				<p><b>1.</b>Write and save the program Open a simple text editor (e.g gedit), IDE (Eclipse) or command line code editor (Nano or Vim).</p> 
				<br>
				<p><b>2.</b>Compile the program. Using command:</p>
				<p>gcc "filename".c</p>
				<p><b>3.</b>Execute the program. Using Command:</p> 
				<p>./a.out</p>

				</div>
				<center><img src="linux_c.jpg" alt="linux_c"></center>
				<div class="holder6"><h1><b>Run C program on Mac</b></h1></div>
				<div class="holder7">
				<p>Mac also supports gcc from the Terminal.Follow the same procedure as Linux.</p>
				</div>
				<div class="holder8"><h1><b>Run C program Online</b></h1></div>
				<div class="holder9">
				<p>There are many online Websites which provide compilation of C program. Some of the service providers are:</p>
				<ul>
					<li>Codepad</li>
					<li>codeChef</li>
					<li>Tutorials Point</li>
					<li>ideone</li>
					<li>Remote Interview IO</li>
					<li>Compile Online</li>
				</ul>
				</div>
				<center><img src="online_c.jpg" alt="online_c"></center>
				<div class="but">
				<a href="c_struc.php" class="button prev">&laquo;prev</a>
				<a href="c_algo.php" class="button next">next &raquo;</a>
				</div> 
