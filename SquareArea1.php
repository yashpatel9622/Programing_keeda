...
<body>
	...
	int main()
	{
		...
		return(0);
				...
				<br>
				<br>
				<img src="SquareAreaOP.png" alt="c programming label"> 
				<div class="but">
					<a href="RectangleArea1.php" class="button prev">&laquo;prev</a>
					<a href="CubeVolume1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
