...
//c.bark();//C.T.Error  
				...
				<br>
				<br>
				<img src="i27.png" alt="c programming label"> 
				<div class="but">
				<a href="A26.php" class="button prev">&laquo;prev</a>
				<a href="A28.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
