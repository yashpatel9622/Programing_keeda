...
#left-panel{width:22%;height:2030px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2010px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
...
<body>
	...
	if(boolean_expression)
	{
		...
		/* statement(s) will execute if the boolean expression is true */
				...
				<div class="holder3">
					<ul>
						<li>If the Boolean expression evaluates to true, then the block of code inside the 'if' statement will be executed. If the Boolean expression evaluates to false, then the first set of code after the end of the 'if' statement (after the closing curly brace) will be executed.</li>
...
<div class="but">
				<a href="c_decision.php" class="button prev">&laquo;prev</a>
				<a href="c_ifelse.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
