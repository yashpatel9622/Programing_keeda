...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>log</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double log(double x);</div>
				<br>
	<h2>Compute natural logarithm</h2>
				<br>
				<div class="header2">
	...
	The natural logarithm is the base-e logarithm, the inverse of the natural exponential function (exp).
				<br>
	For base- 10 logarithms, a specific function log 10 exists. 
				<br>
				<br>
	<h3>Parameters</h3>
	x
	 ...
	 Floating point value.
				<br>
	If the argument is negative, a domain error occurs, setting the global variable error to the value EDOM.
				<br>
	If it is zero, the function returns a negative HUGE_VAL and sets the value of the global variable error to the ERANGE value. 
				<br>
				<br>
	<h3>Return Value</h3>
