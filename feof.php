	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>feof</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int feof(FILE *stream);</div>
				<br>
	<h2>Check End-of-File indicator</h2>
				<br>
				<div class="header2">
	Checks whether the End-of-File indicator associated with stream is set, returning a value different from zero if it is.
				<br>
				<br>
	This indicator is generally set by a pevious operates on the stream that reached the End-of-File.
				<br>
				<br>
