...
<i>Description</i>
<p>
Computer arc tangent: return the principle value of the X tangent.</br> Expressed in radiance .in trignometrics ,arc  tangent is the reverse operation 
of tangent. notice that because of ambiguity,the function can not </br>determine with certainty inwhich quadrant the angle falls only by the tangent value.</br> Additional overloads are provided in this header<camath> for the integer types:These overloads</br> effectively cast X to a double before calculations .
this function also overloaded in <complex>and <valarry>
</p>
<i>prototype</i>
<b> double  atan (double X); float atan(float X); long atan(long X).</b>
<i>parameters</i>
<p>
parameters X value whose arc tangent is computed,</P>
<i>return valus</i>
<p>
principal arc tangent of x, in the interval[-pi/2,+pi/2]radiance value.</br>one radiance is equivalent to 180/PI degrees.
</p>
