...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<div class="Structure">
					<pre>
						<code class="ccode">
						<h1><cinttype>(inttype.h)</h1>
				<h4>type</h4>
				<h4>Header</h4>
				<h4>Description</h4>
				<p>
				C integer types: header with library support for </br>width-basedintegral types.inclidung this header automatically includes also<cstdint>
				<h4>Exampel</h4>
     ...
     int main()
     {
         char buffer[80];
		 intmax_t foo,bar;
		 printf("please enter a num of:");
		 fgets(buffer,80,stdin);
		 foo= strtomix (buffer,Null,100
		 printf("thanks for entering %"PRIDMAX)
		 prinntf("pleas enter the another number");
		 scanf("%" SCNDAX,&bar);
		 printf("%" PRIDMAX "by %" PRIDMAX);
		 return 0;
	}
		...
		<h4>Output</h4>
		<p>please enter a number:10</br>
		Thanks for entering 10.</br>
		please,enter the another number:20</br>
		10 by 20 is 200
</p>	
