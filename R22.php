	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Access specifier</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Acccess specifier</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>

			<p>Variables, methods, and constructors, which are declared protected in a superclass</br> can be accessed only by the subclasses in other package</br> or any class within the package of the protected members' class.</br> The protected access modifier cannot be applied to class and interfaces.
Java provides a number of access modifiers to set access levels for classes, variables,</br> methods, and constructors. The four access levels are −
<br>
<br>
...
<br>
<br>
<h3>Default Access Modifier - No Keyword
</h3>
<p>
Default access modifier means we do not explicitly declare an access modifier for </br>a class, field, method, etc.

A variable or method declared without any access control modifier is available to any other</br> class in the same package. The fields in an interface are implicitly public</br> static final and the methods in an interface are by default public.
</p>
<br>
<br>
<h3>Private Access Modifier - Private
  </h3>
<p>
Methods, variables, and constructors that are declared private can only be accessed </br>within the declared class itself.

Private access modifier is the most restrictive access level. Class and interfaces cannot</br> be private.

</p>
<br>
<br>
<h3>Public Access Modifier - Public
</h3>
<p>
A class, method, constructor, interface, etc. declared public can be accessed from any other class. </br>Therefore, fields, methods, blocks declared inside a public class can be accessed from </br>any class belonging to the Java Universe.
<br>
<br>
<h3> Protected Access Modifier - Protected
</h3>
<p>
Variables, methods, and constructors, which are declared protected in a superclass can be accessed only</br> by the subclasses in other package or any class within the package of the protected members'</br> class.
