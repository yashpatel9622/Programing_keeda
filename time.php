		...
		<div id="container">
			...
			<div id="right-section">
				...
				<table width="100%" height="300">
					<caption><h1>time</h1></caption>
					<tr>
						<th>Option</th>
						<th>Description</th>
					</tr>
					<tr>
						<td><a href="asctime.php">asctime</a></td>
						<td>a string version of the time</td>
					</tr>
					<tr>
						<td><a href="ctime.php">ctime</a></td>
						<td>the string version of the local time</td>
					</tr>
					<tr>
						<td><a href="difftime.php">difftime</a></td>
						<td>the difference between two times</td>
					</tr>
					<tr>
						<td><a href="gmtime.php">gmtime</a></td>
						<td>converts time to Greenwich Mean Time</td>
					</tr>
					<tr>
						<td><a href="localtime.php">localtime</a></td>
						<td>converts time to local time</td>
					</tr>
					<tr>
						<td><a href="mktime.php">mktime</a></td>
						<td>converts a tm structure to calendar time</td>
					</tr>
