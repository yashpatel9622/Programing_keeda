	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Context of applet</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Context of applet<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
<p>
the Context of the currently executing applet by calling the getAppletContext () method defined by</br> the Applet. Once the context of the applet is obtained</br> with in an applet, another document can be brought into view by calling showDocument () method.


 
<h2>There are two showDocument () methods which are as follows:</h2>

showDocument(URL url)

showDocument(URL url,string lac)

where,url is the URL from where the document is to be brought into view.
lac is the location within the browser window where the specified document is to be displayed.</p>
<br>
<br>
<h3>Example An applet code to demonstrate the use of AppletContext and showDocument ().</h3>
<pre>
