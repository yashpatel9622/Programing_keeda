...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>Data Types</p></b></i></center></h1></div>	
				<div class="holder2">
				<ul>
				<b>Integer:</b>This group includes byte,short,int and long,which are whole signed numbers
				<br>
				<br>
				<b>Floating-Point Numbers:</b>This group includes float and double,which represent number with fraction precision.
				<br>
				<br>
				<b>Character:</b> This group includes char,which represents character set like letter and number.
				<br>
				<br>
				...
				<b>byte: </b>-128 to 127(1 byte)
				<br>
				<br>
				<b>Short:</b>-32,768 to +32,767(2 bytes)
				<br>
				<br>
				<b>int:</b> -2,147,483,648 to +2,147,488,647(4 bytes)
				<br>
				<br>
				<b>float:</b>3 4e-038 to 1.7e+308(8 bytes)
				<br>
				<br>
				<b>char:</b>holds only a single character(2 bytes)
				<br>
				<br>
				<b>boolean:</b>can take only true or false (1 byte)				</ul>
				</div>
				
			<div class="but">
		
				<a href="java_operator.php" class="button next">prev &raquo;</a>
				<a href="java_if.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
