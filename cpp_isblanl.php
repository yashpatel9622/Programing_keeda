...
<i>Description</i>
<p>
check if character is alphabrtic: checks whether c is blank character. 
A blank character is a space character used to seperate "C" locale consider blank</br> a  character('\t') and the space character('').
other locale may considered blank a different selection of characters but they must also</br> be space characters of the standard ASCII character set,see the refernce for the <cctype>
header.in C++,a locale-specified template versionof this function(isblank) </br>exist in header<locale> Compatibility notes: Standardrizer in C99(C++11).


</p>
<i>prototype</i>
<b>int isblankint c);</b>
<i>parameters</i>
<p>
