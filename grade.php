...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Calculate Grade of Student</h1>
				<div class="Structure">
					<pre>
						<code class="ccode" >
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="grade.jpg" alt="c programming label"> 
				<div class="but">
					<a href="mean.php" class="button prev">&laquo;prev</a>
					<a href="table.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
