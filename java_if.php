...
<div id="right-section">
				...
				<div class="holder2">
					...
					<ul>
						<b> If Statement:</b> This is a control  statement to execute a single statement or a block of code,when the given condition is true and if it is false then it skips if block and rest of program is executed.
					    <br>
						Syntax: <br> 
			...
			<div class="but">
				...
				<a href="java_datat.php" class="button next">prev &raquo;</a>
				<a href="java_ifelse.php" class="button next">next &raquo;</a>
				</div>
</div>
