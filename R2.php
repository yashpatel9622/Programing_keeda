	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>  Quick variable and datatype</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>Quick basics</h2></div>
				<div class="header1">
						
						<p>
						The platform independent feature of Java is achieved through bytecode. The eight primitive <br>data types are: byte, short, int, long, float, double, boolean, and char.<br> The java.lang.String class represents character strings.<br> Instance variables (non-static fields) are unique to each instance of a class.
						</P>
						<br>
						<br>
						<h3> Primitive datatype in java</h3>
						
						<p>Category	Types	Size (bits)	Minimum Value	Maximum Value	Precision	Example
...
<p> datatype variable_name= value</p>
<br>
<br>
...
<h3> Array</h3>
<p>
Java array is an object the contains elements of similar data type. </br>It is a data structure where we store similar elements. We can store </br>only fixed set of elements in a java array.
