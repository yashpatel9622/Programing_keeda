...
<body>
  ...
  <h1 style=color:green;>Quiz : The Array of C</h1>
  <br>
  <br>
  <ol class="quiz">
 <div class="q1">
  ...
  <b>Que 1: Which of the following correctly declares an array?</b>
      <ul class="answers">
        <li><input type="radio" name="question-1" id="answer-1-1"><label for="answer-1-1">A. int anarray[10];</label> </li>
        <li><input type="radio" name="question-1" id="answer-1-2"><label for="answer-1-2">B. int anarray;</label></li>
        <li><input type="radio" name="question-1" id="answer-1-3"><label for="answer-1-3">C. anarray{10};</label></li>
        <li><input type="radio" name="question-1" id="answer-1-4"><label for="answer-1-4">D. array anarray[10];</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 2: What is the index number of the last element of an array with 29 elements?</b>
      <ul class="answers">
        <li><input type="radio" name="question-2" id="answer-2-1"><label for="answer-2-1">A. 29</label></li>
        <li><input type="radio" name="question-2" id="answer-2-2"><label for="answer-2-2">B. 28</label></li>
		<li><input type="radio" name="question-2" id="answer-2-3"><label for="answer-2-3">C. 0</label></li>
        <li><input type="radio" name="question-2" id="answer-2-4"><label for="answer-2-4">D. Programmerdefined</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b>Que 3:  Which of the following is a two-dimensional array?</b>
      <ul class="answers">
        <li><input type="radio" name="question-3" id="answer-3-1"><label for="answer-3-1">A. array anarray[20][20];</label></li>
        <li><input type="radio" name="question-3" id="answer-3-2"><label for="answer-3-2">B. int anarray[20][20];</label></li>
        <li><input type="radio" name="question-3" id="answer-3-3"><label for="answer-3-3">C. int array[20,20];</label></li>
        <li><input type="radio" name="question-3" id="answer-3-4"><label for="answer-3-4">D. char array[20];</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
<b> Que 4: Which of the following correctly accessess the seventh element stored in foo, an array with 100 elements?</b>
      <ul class="answers">
        <li><input type="radio" name="question-4" id="answer-4-1"><label for="answer-4-1">A. foo[6];</label></li>
        <li><input type="radio" name="question-4" id="answer-4-2"><label for="answer-4-2">B. foo[7];</label></li>
		 <li><input type="radio" name="question-4" id="answer-4-3"><label for="answer-4-3">C. foo(7);</label></li>
        <li><input type="radio" name="question-4" id="answer-4-4"><label for="answer-4-4">D. foo;</label></li>
	  </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 5: Which ofthe following gives the memory address of the first element in array foo, an array with 100 elements?</b>
      <ul class="answers">
        <li><input type="radio" name="question-5" id="answer-5-1"><label for="answer-5-1">A. foo[0];</label></li>
        <li><input type="radio" name="question-5" id="answer-5-2"><label for="answer-5-2">B. foo;</label></li>
        <li><input type="radio" name="question-5" id="answer-5-3"><label for="answer-5-3">C. &foo;</label></li>
        <li><input type="radio" name="question-5" id="answer-5-4"><label for="answer-5-4">D. foo[1];</label></li>
	   </ul>
    </li>
	</div>
	<br>
	<br>
	 <div class="q1">
    <li>
 <b>Que 6: What will happen if in a C program you assign a value to an array element whose subscript exceeds the size of array?</b>
      <ul class="answers">
        <li><input type="radio" name="question-6" id="answer-6-1"><label for="answer-6-1">A. The element will be set to 0.</label></li>
        <li><input type="radio" name="question-6" id="answer-6-2"><label for="answer-6-2">B. The compiler would report an error.</label></li>
        <li><input type="radio" name="question-6" id="answer-6-3"><label for="answer-6-3">C. The program may crash if some important data gets overwritten</label></li>
        <li><input type="radio" name="question-6" id="answer-6-4"><label for="answer-6-4">D. The array size would appropriately grow</label></li>
      </ul>
    </li>
	</div>
	<br>
	<br>
 	 <div class="q1">
    <li>
<b>Que 7: A pointer to a block memory is effectively same as an array</b>
      <ul class="answers">
	...
	<br>
	 <div class="q1">
    <li>
 <b>Que 8: Are the expressin arr and &arr same for an array of 10 integers?</b>
      <ul class="answers">
  ...
  int main()
  {
      ...
      <ul class="answers">
        <li><input type="radio" name="question-9" id="answer-9-1"><label for="answer-9-1">A. 2,1,15</label></li>
        <li><input type="radio" name="question-9" id="answer-9-2"><label for="answer-9-2">B. 1,2,5</label></li>
        <li><input type="radio" name="question-9" id="answer-9-3"><label for="answer-9-3">C. 3,2,15</label></li>
        <li><input type="radio" name="question-9" id="answer-9-4"><label for="answer-9-4">D. 2,3,20</label></li>
      </ul>
    </li>
	</div>
	<br>
