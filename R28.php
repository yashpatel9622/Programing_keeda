	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Mutithreading in java </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>multithreading in java<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
Thread is basically a lightweight sub-process, a smallest unit of processing.</br> Multiprocessing and multithreading, both are used to achieve multitasking.

But we use multithreading than multiprocessing because threads share a common memory area. </br>They don't allocate separate memory area so saves memory, and context-switching between </br>the threads takes less time than process.
...
<h2>New</h2>
<p>
When we create a new Thread object using new operator, thread state is New Thread.</br> At this point, thread is not alive and it’s a state internal to Java programming.

<h2>Runnable</h2>
<p>
When we call start() function on Thread object, it’s state is changed to Runnable.</br> The control is given to Thread scheduler to finish it’s execution. Whether to run this thread</br> instantly or keep it in runnable thread pool before running, depends on the OS implementation</br> of thread scheduler.
</p>
<h2>Running</h2>
When thread is executing, it’s state is changed to Running. </br>Thread scheduler picks one of the thread from the runnable thread pool and change</br> it’s state to Running. Then CPU starts executing this thread. A thread can change state to Runnable,</br> Dead or Blocked from running state depends on time slicing, thread completion of run() method or waiting for some resources.

<h2>Blocked/Waiting</h2>
<p>
A thread can be waiting for other thread to finish using thread join or it can be waiting for some resources to available. For example producer consumer problem</br> or waiter notifier implementation or IO resources, then it’s state is changed to Waiting. </br>Once the thread wait state is over, it’s state is changed to Runnable and it’s moved back to runnable thread pool.
</p>
<h2>Dead</h2>
<p>
Once the thread finished executing, it’s state is changed to Dead and it’s </br>considered to be not alive.
</p>
