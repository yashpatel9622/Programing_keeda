...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Delete element from array</h1>
				<div class="DeleteArray">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="DeleteArrayOP.png" alt="c programming label"> 
				<div class="but">
					<a href="InsertArray1.php" class="button prev">&laquo;prev</a>
					<a href="LinearSearch1.php" class="button next">next &raquo;</a>
				</div>	
			</div>
		</div>
		<div id="footer">
