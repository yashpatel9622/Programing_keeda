...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>Variables</p></b></i></center></h1></div>	
				<div class="holder2">
				
					<ul>
						<li>A variable provides us with named storage that our programs can manipulate.</li>			<br>
						<li>Each variable in java has a specific type,which determines the size and layout of the variables memory,the range of values that can be stored within that memory,ans set of operations that can be applied to the variable.</li>	<br>
						
						<li>you can must declare all variables before they can be used.</li>
	                     </li>the basic form of a variable declaration is shown here:
                            <br>
							data_type variable=value;</li>
						<li>Following are valid examples of vriable declaration and initialization in java:
						<br>
						int a,b,c;
						<br>
						//Declare three ints a,b,c.
						<br>
						int a=10,b=10;
						<br>
						...
						double pi=3.14159;
						<br>
						//declares ans assigns a value of pi.
						<br>
						char a='a';
						<br>
						//the char variables a initialize with value 'a'</li>
						<li><b>Constant</b>:During the execution of program,value of variable may change.A constant represents permanent data that never changes.</li>
						<li>if you want use some value likes p=3.14159; no need to type every time instead you can simpl define constant for p,followion is the syntax for declaring constant.
						<br>
						<b>Syntax:</b>Static final datatype ConstantName=value;</li>
						<li><b>Example:</b>static final float pi=3.14159;</li>
					</ul>
				</div>
			...
			<div class="but">
				...
				<a href="java_operator.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
