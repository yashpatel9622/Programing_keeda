...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="BinaryToHexaOP.png" alt="c programming label"> 
				<div class="but">
					<a href="BinaryToOctal1.php" class="button prev">&laquo;prev</a>
					<a href="MaxArray1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
