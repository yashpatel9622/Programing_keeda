	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<ul>
				<li>In any programming language,loops are used to execute a set of statements repeatedly until a particular condition is satisfied.</li>
				<br>
				<b>How it works:</b>
				<li>A sequence of statement is executed until a specified condition is true.This sequence of statement to be executed is kept inside the curly braces {} known as loop body.
				<br>
				<li>After every execution of loop body,condition is checked,and if it is found to be true the loop body is executed again.When condition check comes out to be false,the loop body will not be executed.</li>
				</ul>
				</div>
				<br>
			...
			<div class="but">
				<a href="cpp_switch.php" class="button prev">&laquo;prev</a>
				<a href="cpp_while.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
