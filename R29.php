	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>Methods of thread </p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>methods of thread<h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>
<h2>String getName()</h2>	Retrieves the name of running thread in the current</br> context in String format
<br>
<br>
<h2>void start()</h2>	This method will start a new thread of execution by calling run() </br>method of Thread/runnable object.
<br>
<br>
<h2>void run()</h2>	This method is the entry point of the thread. Execution of thread</br> starts from this method.
<br>
<br>
<h2>void sleep(int sleeptime)</h2>	This method suspend the thread for mentioned time </br>duration in argument (sleeptime in ms)
<br>
<br>
<h2>void yield()</h2>	By invoking this method the current thread pause its execution</br> temporarily and allow other threads to execute.
<br>
<br>
<h2>void join()</h2>	This method used to queue up a thread in execution. Once called on thread,</br> current thread will wait till calling thread completes its execution
<br>
<br>
<h2>boolean isAlive()</h2>	This method will check if thread is alive or dead
</p>
