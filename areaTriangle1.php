...
<body>
	...
	int main()
	{
		...
		printf("Area of triangle is %f",ans);
				...
				<br>
				<br>
				<img src="areaTriangleOP.png" alt="c programming label"> 
				<div class="but">
					<a href="addition1.php" class="button prev">&laquo;prev</a>
					<a href="oddEven1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
