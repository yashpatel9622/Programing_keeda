	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Command line Arguments</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Command line Arguments</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>
The command line argument is the argument passed to a program at the time when you run it.</br> To access the command-line argument inside a java program is quite easy,</br> they are stored as string in String array passed to the args parameter of main() method.</p>
<br>
<br>
<h3>Example</h3>
...
<br>
<br>
<h3>Execute this program as java cmd 10 20 30</h3>
<p>
10
20
30
