...
<body>
	...
	void main()
	{
		...
		printf("\nGross salary:%d",gross_salary);
				...
				<br>
				<br>
				<img src="GrossSalaryOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Percentage1.php" class="button prev">&laquo;prev</a>
					<a href="SimpleInterest1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
