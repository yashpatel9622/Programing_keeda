...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Inheritance</p></b></i></center></h1></div>				
					<ul>
					<b>Inheritance:</b>It is one of key feature of object oriented programming.inheritance provides mechanism that allowed a class to inherit property of another class.when a class extends another class it inherits all non-private members including fields and methods.
					<br><br><b>Types of Inheritance:</b><br>
					<b>1.</b>single Inheritance.
					<br>
					<b>2.</b>Multiple Inheritance<br>
					<b>3.</b>Multilevel Inheritance<br>
					<b>4.</b>Hybrid Inheritance<br>
			...
			<div class="but">
						...
						<a href="java_string.php" class="button next">prev &raquo;</a>
				<a href="java_single.php" class="button next">next &raquo;</a>
				</div>
</div>
