	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>strncmp</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">int strncmp(const char *str1,const char *str2,size_t count);</div>
				<br>
	<h2>Compare characters of two strings</h2>
				<br>
				<div class="header2">
