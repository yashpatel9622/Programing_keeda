...
<body>
	...
	main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="CopyStringOP.png" alt="c programming label"> 
				<div class="but">
					<a href="CompareString1.php" class="button prev">&laquo;prev</a>
					<a href="ConcatenateString1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
