	...
	int check_vowel(char c)
	{
		switch(c)
		{
			...
			default:
				...
				<br>
				<br>
				<img src="DeleteVowelsOP.png" alt="c programming label"> 
				<div class="but">
					<a href="RverseString1.php" class="button prev">&laquo;prev</a>
					<a href="SwapString1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
