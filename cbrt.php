	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<center style=font-size:25px;><h1 style=color:green;> cbrt</h1></center>
			<br>
			<hr>
			<br>
...
Computer cubic root: return the cubic root of the X.
 Additional overloads are provided in this header<camath> for <br>the integer types:These overloads effectively cast X to a double before <br>calculations .
</p>
<br>
<h2>prototype</h2>
<br>
<b style=font-size:25px;> double  cbrt (double X); float cbrt(float X); long cbrt(long X).</b>
<br>
<h2>parameters</h2>
<br>
<p style=font-size:25px;>
parameters X value whose arc cubic root is computed.</P>
<br>
<h2>return valus</h2>
<br>
<p style=font-size:25px;>
cubic root of value X.
</p>
