...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Addition using pointer</h1>
				<div class="PointerAddition">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="PointerAdditionOP.png" alt="c programming label"> 
				<div class="but">
					<a href="SwapString1.php" class="button prev">&laquo;prev</a>
					<a href="PointerReverse1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
