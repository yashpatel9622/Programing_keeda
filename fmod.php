...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>fmod</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double fmod(double numerator, double denominator);</div>
				<br>
	<h2>Compute remainder of division</h2>
				<br>
				<div class="header2">
	Returns the floating-point remainder of numerator/ denominator.
				<br>
				<br>
	The remainder of a division operation is the result of substracting  the integral quotient multiplied by the denominator from the numerator.
				<br>
				<br>
	...
	Floating point value with the division denominator.
				...
				<br>
	<h3>Return Value</h3>
	The remainder if dividing the arguments.
				</div>
