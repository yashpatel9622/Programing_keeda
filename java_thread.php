...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>Life Cycle of a Thread</p></b></i></center></h1></div>	
				<div class="holder2">
				
					<ul>
					<b> Life Cycle</b> The life cycle ogthe thread on java is controlled by JVM.
					A thread can bein one ofthe five sates
					New
					Runnable
					Running
					Non-Runnable
					...
					<br>
					<b> New</b>
					The thread is in new state if you careate an instance of a Thread class but before the invocation of start() method
					<br>
					<br>
					<b> Runnable</b>
					The thread is in runnable stateafter invocation of start(). method ,but the thread scheduler has notselected it to be the  Running thread.
					<br>
					<br>
					<b> Runnable</b>
					The thread is in runningstate ifthe thread scheduler has selected it.
					<br>
					<br>
					<b>Non-Runnable</b>
					This is the when the thread is still alive, butis currently waiting for other thread to finish usingthread join or it can be waitingfor some resoueces to available.
					<br>
					<br>
					<b>Terminated</b>
					A thread is in termimnated state when its run() mehod exist.
					<br>
					<br>
					<br>
					<b>Thread</b>are implemented in the form of objects that contain amethod called run()
					<br>
					<br>
					the method run() is the geartand soul of any thread.
					<br>
					public void  run()
					<br>
					{/*your implementation ofthe thread here*/
					<br>
					}
...
<br>
<br>
					<i> A new thread can be created in two ways</i>
					<br>
					<b>1. By creatinga thread class:</b>
					Define a class that extends Thread class and oveide its run() method with the code required by the thread<br>
					<br>
					<b>2.By converting  a classs to a thread:</b>
					Definne a class that implements Runnable interface,The runnable interface has only one method,run(),that is to be defined in the method will the code to be executed by the thread.
			...
			<div class="but">
				...
				<a href="java_hybrid.php" class="button next">prev &raquo;</a>
				<a href="java_MethodO.php" class="button next">next &raquo;</a>
				</div>
</div>
	</div>
