	...
	int main()
	{
		...
		for(c=0;c printf("%d\n",array[c]);
			return 0;
				...
				<br>
				<br>
				<img src="InsertArrayOP.png" alt="c programming label"> 
				<div class="but">
					<a href="Array1.php" class="button prev">&laquo;prev</a>
					<a href="DeleteArray1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
