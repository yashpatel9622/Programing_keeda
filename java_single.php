...
<div id="right-section">
				...
				<div class="holder6"><h1><center><i><b><p>Single Inheritance</p></b></i></center></h1></div>				
					<ul>
					<b>Single Inheritance:</b>When a class extends another class only then we call it a single inheritance.
					<br>					
					<b>Example:</b>
					class A{<br>
					}<br>
			...
			<div class="but">
				...
				<a href="java_inherit.php" class="button next">prev &raquo;</a>
				<a href="java_multiple.php" class="button next">next &raquo;</a>
				</div>
</div>
