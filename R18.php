	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Inner classses</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Inner classes</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>Nested Classes. In Java, just like methods, variables of a class too can have another class as its member. </br>Writing a class within another is allowed in Java. The class written within is called the nested </br>class, and the class that holds the inner class is called the outer class.
</p>
<br>
<br>
<b>Following is the program to create an inner class and access it. In the given example, we make the inner class private and access the class through a method.
</b>
<br>
<br>
<h3>Example</h3>
