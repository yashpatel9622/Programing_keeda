...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Length of string using pointer</h1>
				<div class="PointerLength">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	int string_In(char*p)
	{
		...
		return count;
				...
				<br>
				<br>
				<img src="PointerLengthOP.png" alt="c programming label"> 
				<div class="but">
					<a href="PointerArraySum1.php" class="button prev">&laquo;prev</a>
					<a href="Structure1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
