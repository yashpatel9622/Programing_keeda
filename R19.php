	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Abstract class</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Abstract class</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
...
<p>An abstract class is a class that is declared abstract —it may or may not include </br>abstract methods. Abstract classes cannot be instantiated, but they can be subclassed.</br> When an abstract class is subclassed, the subclass usually provides implementations for all </br>of the abstract methods in its parent class.
</p>


<h3>If a class includes abstract methods, then the class itself must be declared abstract, as in:
</h3>
<p>
