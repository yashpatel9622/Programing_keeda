...
<body>
	...
	void  main()
	{
		long num,decimal_num,remainder,base=1,
		binary=0;
		...
		binary);
				...
				<br>
				<br>
				<img src="DecimalToBinaryOP.png" alt="c programming label"> 
				<div class="but">
					<a href="DecimalToBinaryBit1.php" class="button prev">&laquo;prev</a>
					<a href="DecimalToOctal1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
