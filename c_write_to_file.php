	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Writing to a file</p></b></i></center></h1></div>	
				<br>

				<h4>Write to a text file using fprintf()</h4>
...
<p>This program takes a number from user and stores in the file program.txt.</p>
<p>After you compile and run this program, you can see a text file program.txt created in C drive of your computer. When you open the file, you can see the integer you entered.</p>
				...
				<div class="but">
				<a href="c_file_handling.php" class="button prev">&laquo;prev</a>
				<a href="c_reading_from_file.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
