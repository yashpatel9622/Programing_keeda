...
<body>
	...
	void main()
	{
		...
		getch();
				...
				<br>
				<br>
				<img src="calc.jpg" alt="c programming label"> 
				<div class="but">
					<a href="asmd.php" class="button prev">&laquo;prev</a>
					<a href="digits.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
