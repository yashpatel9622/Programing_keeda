	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<h1><cfloat>(float.h)</h1>
				<h4>type</h4>
				<h2>Header</h2>
				<h4>Description</h4>
				<p>
				characterstics of floating-point types:</br> this header describe the characterstics of floating type for the specific system </br>and compiler implementation used.</br>
				a folating-point of four element:a sign:either </br>negative and non-negativea base which express the differnt numbers</br> that can be represented with a single digit(2 for binary,10 for decimal,16 for</br> hexadecimal... an so on)the num of series is known as precision.
				</p>
