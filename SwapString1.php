...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="SwapStringOP.png" alt="c programming label"> 
				<div class="but">
					<a href="DeleteVowels1.php" class="button prev">&laquo;prev</a>
					<a href="PointerAddition1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
