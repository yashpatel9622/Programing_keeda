	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p> Identifiers</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Identifiers</h2></div>
				<div class="header1">
				<br>
				<br>
				<p>
Identifiers in Java. Identifiers are the names of variables, methods, classes, packages and interfaces.</br> Unlike literals they are not the things themselves, just ways of referring to them. </br>In the HelloWorld program, HelloWorld , String , args , main and println are identifiers.</p>
<h3>Serral stepsto remeber about java identifier</p>
<p>
*like class, continue, void, else, and if cannot be used. Check that link for even more reserved words to avoid
*"Java letters" is the term given to the acceptable letters that can be used for an identifier.</br> This includes not only regular alphabet letters but also symbols, which just includes, without exception,</br> the underscore (_) and dollar sign ($)
"Java digits" include the numbers 0-9
*An identifier can begin with a letter, dollar sign, or underscore, but not a digit. However, </br>it's important to realize that digits can be used so long as they exist after the first character,</br> likee8xmple
Java letters and digits can be anything from the Unicode character set, which means characters in Chinese,</br> Japanese, and other languages can be used
