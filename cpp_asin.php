...
<i>Description</i>
<p>
Computer arc sin: return the principle value of the X sin.</br> Expressed in radiance .in trignometrics ,arc  sin is the reverse operation 
of sin. Additional overloads are provided in this header<camath> </br>for the integer types:These overloads effectively cast X to a double before </br>calculations .
this function also overloaded in <complex>and <valarry>
</p>
<i>prototype</i>
<b> double  asin (double X); float asin(float X); long asin (long X).</b>
<i>parameters</i>
<p>
parameters X value whose arc sin is computed, in the interval[-1,+1].if </br>the argument is out of interval,adomain error occurs.
</P>
<i>return valus</i>
<p>
principal arc sin of x, in the interval[-pi/2,+pi/2]radiance value.
</p>
