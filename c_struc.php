...
<body>
	...
	---------------------------------------------
			...
			The Symbols /* and*/ used for comment. This Comments are ignored by the compiler,and are used to provide useful information about program to human who use it.
				...
				<br>
				<div class="holder10">
				braces surround the body of the function, which may have one or more instruction/statements.
				</div>
				<br>
				<br>
				<div class="holder11">
				...
				<br>
				<div class="holder14">
				This is a string that will be display on user screen. 
				\n is the newline character.
				; a semicolon ends a statement.
				</div>
				<div class="holder15">
				<ul>
				<li>C is case sensitive language, so the names of the functions must be typed in lower case as above</li><br>
				<li>We can use white spaces, tabs and new line character to make our code easy to read.</li>
				</ul>
				</div>
				<div class="but">
				<a href="c_history.php" class="button prev">&laquo;prev</a>
				<a href="c_before.php" class="button next">next &raquo;</a>
				</div> 
				
			</div>
		</div>
		<div id="footer">
			<div class="holder16"><center><a href="aboutus.php"> About Us </a> | <a href="contactus.php">Contact Us </a> | <a href="pp.php">Privacy & Policy</a></center></div>
		<br>
