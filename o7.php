...
<body>
	...
	<br>
			<center style=font-size:25px;><h1 style=color:green;> ostream </h1></center>
			<br>
			<hr>
			<br>
...
<p style=font-size:25px;> 
 output stream: header providing the standard output and combined input/output stream classes.
</p>
