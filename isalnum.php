...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>isalnum</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int isalnum(int c);</div>
				<br>
	<h2>Check if character is alphanumeric</h2>
				<br>
				<div class="header2">
	...
	The result is true if either isalpha or isdigit would also return true.
				<br>
				<br>
	Notice that what is considered a letter may depend on the locale being used;In the default C locale, 
	what constitutes a letter is what returns true by either isupper or islower.
				<br>
				<br>
	<h3>Parameters</h3>
	c
