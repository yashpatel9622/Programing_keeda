...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h2>C Program to print "Hello World" with semicolon</h2>
				<br>
				<div class="cex">
					<pre>
						<code class="ccode" >
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="maOP.png" alt="c programming label"> 
				<br>
				<br>
				<hr>
				<br>
				<br>
				<h2>C Program to print "Hello World" using if statement and without using semicolon</h2>
				<br>
				<div class="cex1">
					<pre>
						<code class="ccode" >
	...
	{    
		...
		return 0;  
				...
				<br>
				<br>
				<h2>C Program to print "hello world" using while loop and without using semicolon.</h2>
				<br>
				<div class="cex2">
					<pre>
						<code class="ccode" >
	...
	{    
	   while(!printf("hello world")){}    
		return 0;  
				...
				<div class="but">
					<a href="integer1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
