...
<center style=font-size:25px;><h1 style=color:green;> isofwd</h1></center>
			<br>
			<hr>
			<br>
...
Input-Output forword declarations: This header provides forword declaration for the types of the standard input-oytput libary,<br>
  <br>
ain the template defination , and thus shall only be include in other headers to provide forword declaration of these types</p>
