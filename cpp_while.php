...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>while Loop</p></b></i></center></h1></div>
				<p>It repeats a statement or group of statements while a given condition is true.It tests the condition before executing the loop body.</p>
				<br>
				<div class="example"><h4>Syntax:</h4></div>
				<br>
				<p>The syntax of an while loop in C++ programming language is −</p>
				<div class="holder2">
				<pre><code>
	while(condition) 
	{
		statement(s);
				...
				<div class="holder3">
					<ul>
						<li>Here, statement(s) may be a single statement or a block of statements. The condition may be any expression, and true is any nonzero value. The loop iterates while the condition is true.</li>
						<li>When the condition becomes false, the program control passes to the line immediately following the loop.</li>
					</ul>
				</div>
				<div class="example"><h4>Flowchart:</h4></div>
				<center><img src="flowchart-while-statement.png" alt="while-stat"></center> 
   ...
   return 0;
	...
	value of a: 19
			...
			<div class="but">
				<a href="cpp_loop.php" class="button prev">&laquo;prev</a>
				<a href="cpp_do.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
			...
			<br>
			<div class="holder7"><center>Copyright © 2018 DiplomaLang.com | All rights reserved.</center></div>
		</div>
	</div>
</div>
</body>
