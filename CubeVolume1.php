...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1>Volume of Cube</h1>
				<div class="CubeVolume">
					<pre>
						<code class="ccode" >
	#include&ltstdio.h&gt;
	...
	void main()
	{
		...
		printf("\nVolume of cube is:%.3f",volume);
				...
				<br>
				<br>
				<img src="CubeVolumeOP.png" alt="c programming label"> 
				<div class="but">
					<a href="SquareArea1.php" class="button prev">&laquo;prev</a>
					<a href="CylinderVolume1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
