...
#left-panel{width:22%;height:2620px;background-color:#eda150;float:left;padding:10px;}
		.sidebar ul
		{
			list-style:none;
			margin:0;
...
#right-section{width:73%;height:2600px;background-color:#bcc92b;float:right;padding:20px;font-size:28px;}
.holder1{
padding:10px;
font-size:20px;
}
...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<div class="holder1"><h1><center><i><b><p>Structure</p></b></i></center></h1></div>
				<br>
				<p>In array we can store data of one type only, but structure is variable that gives facility of storing data of different data type in one variable.</p>
				<br>
				<p>Structures are variables that have several parts; each part of the object can have different types.</p>
				<br>
				<p>Each part of the structure is called a member of the structure.</p>
				<br>
				<div class="holder3">
				<h3 style=color:green>Declaration</h3>
				<br>
				<ul>
					<li>Consider basic data of student:</li>
					<br>
					<p>roll_no,class,name,age,address.</p>
					<br>
					<li>A structure data type called student can hold all this information:</li>
					<br>
				</ul>
				<pre>
	struct student
	{
		...
		char address[50];
				...
				<ul>
				<li>before the final semicolon, At the end of the structure's definition, we can specify one or more structure variables.</li>
				<br>
				<li>There is also another way of declaring variables given below,
				<br>
				<p>struct student s1;</p>
				<br>
				</ul>
				<h3 style=color:green>Initialization</h3>
				<br>
				<ul>
					<li>Structure members can be initialized at declaration.This is same as the initialization of arrays; the values are listed inside braces. The structure decaration is preceded by the keyword static.</li>
					<br>
					<p>static struct student pradeep={1234,"comp","pradeep",20,"mumbai"};
					
				</ul>
				<br>
				<h3 style=color:green>Accecssing structure data</h3>
				<br>
				<ul>
					<li>To access a given member the dot notation is use. The "dot" is called the member access operator.</li>
					<br>
				</ul>
				<pre>
	struct student s1;
	...
	s1.roll_no=1234
				...
				<br>
				<ul>
					<li>A structure type declaration can be local or global, depending upon where the declaration is made.</li>
				</ul>
				<br>
				<h3 style=color:green>Structures as Function Arguments</h3>
				<br>
				<ul>
					<li>You can pass a structure as a function argument in very similar way as you pass any other variable or pointer. You would access structure variables in the similar way as you have accessed in the above example.</li>
				</ul>
				<br>
				<h3 style=color:green>Pointers to Structures</h3>
				<br>
				<ul>
					<li>You can define pointers to structures in very similar way as you define pointer to any other variable as follows:</li>
				</ul>
				<br>
				<p>struct student *struct_pointer;</p>
				
				
				</div>
				
				<div class="but">
				<a href="cpp_pointer.php" class="button prev">&laquo;prev</a>
				<a href="cpp_constructor.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
