...
<div id="right-section">
				...
				<div class="holder1"><h1><center><i><b><p>Method Overloading</p></b></i></center></h1></div>	
				<div class="holder2">
				
					<ul>
					<b> Method overloading:</b> If a class have a multiple method by same name but different parameters it is known as method overloading.ie we have to perform only one operation,having same name og the methods increases the readability of the program.
					
					<br>
					<br>
					    <b> Arguments list could differ in:</b>
						<br>
						1. number of parameters.
						2.Data type of parameters.
						3. Sequence of data type of paameter.
						<br>
						<br>
						<b> method overloading is also known as static polymorphism.<b>
						
						<br>
						<br>
						<b> By changing number of parameters</b>
						<br>
						<br>
						...
						<b> By changing number of Datatype</b>
						<br>
						<br>
						class DisplayOverloading
						<br>
			...
			<div class="but">
				...
				<a href="java_thread.php" class="button next">prev &raquo;</a>
				</div>
</div>
	</div>
