...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="PrintPatternOP.png" alt="c programming label"> 
				<div class="but">
					<a href="FibonacciRecursion1.php" class="button prev">&laquo;prev</a>
					<a href="DiamondPattern1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
