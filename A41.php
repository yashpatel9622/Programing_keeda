...
class TestAnonymousInner{  
 public static void main(String args[]){  
  ...
  p.eat();  
				...
				<br>
				<br>
				<img src="i41.png" alt="c programming label"> 
				<div class="but">
				<a href="A40.php" class="button prev">&laquo;prev</a>
				<a href="A42.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
