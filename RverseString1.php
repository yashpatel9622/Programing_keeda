...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="RverseStringOP.png" alt="c programming label"> 
				<div class="but">
					<a href="ConcatenateString1.php" class="button prev">&laquo;prev</a>
					<a href="DeleteVowels1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
