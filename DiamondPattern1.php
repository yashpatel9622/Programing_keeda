...
<body>
	...
	int main()
	{
		...
		return 0;
				...
				<br>
				<br>
				<img src="DiamondPatternOP.png" alt="c programming label"> 
				<div class="but">
					<a href="PrintPattern1.php" class="button prev">&laquo;prev</a>
					<a href="FloydsTriangle1.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
