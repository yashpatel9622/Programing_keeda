	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>strncat</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< string.h></h2></div>
				<div class="header1">char *strncat(char *destination,const char *source,size_t count);</div>
				<br>
	<h2>Append characters from string</h2>
				<br>
				<div class="header2">
