...
<body>
	...
	void main()
	{
		...
		printf("Converted Value:%f",value);
				...
				<br>
				<br>
				<img src="TemperatureOP.png" alt="c programming label"> 
				<div class="but">
					<a href="GenerateArmstrong1.php" class="button prev">&laquo;prev</a>
					<a href="FactFunction1.php" class="button next">next &raquo;</a>
				</div>	
			</div>
		</div>
		<div id="footer">
