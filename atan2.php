...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>atan2</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< math.h></h2></div>
				<div class="header1">double atan2(double y,double x);</div>
				<br>
	<h2>Compute arc tangent with two parameters</h2>
				<br>
				<div class="header2">
	...
	x
	 ...
	 Floating point value representing an x-coordinate.
				<br>
				<br>
	If both arguments passed are zero, a domain error occurs, which sets the global variable error to the EDOM value.
				<br>
				<br>
	<h3>Return Value</h3>
