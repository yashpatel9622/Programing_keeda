	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<table width="100%" height="150">
				<caption><h1>stdarg</h1></caption>
				<tr>
					<th>Option</th>
					<th>Description</th>
				</tr>
				<tr>
					<td><a href="va_arg.php">va_arg</a></td>
					<td>use variable length parameter lists</td>
				</tr>
				<tr>
					<td><a href="va_start.php">va_start</a></td>
					<td>initialize variable length parameter list handle</td>
				</tr>
				<tr>
					<td><a href="va_end.php">va_end</a></td>
					<td>enables a functions with variable length parameter list to return</td>
				</tr>
			</table>
