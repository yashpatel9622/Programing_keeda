	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
	<center style=font-size:25px;><h1 style=color:green;>  exception</h1></center>
			<br>
			<hr>
			<br>
...
<td>get smart pinter to current exception</td>
</tr>
<tr>

 <td> std::get_terminate</td>
 <td> get terminal handler function</td>
 </tr>

 <tr>

<td> std::get_unexcepted</td>
<td> get unexcepted handler function</td>

</tr>
<tr>

<td >std::set_terminate</td>
<td> set terminal handler function</td>

</tr>
<tr>

<td> std::set_unexcepted</td>
<td> set unexcepted handler function</td>

</tr>
<tr>

<td> std::terminate</td>
<td>  function handling teriation on exception</td>

</tr>
<tr>

<td> std::bad_exception</td>
<td> exception thrown by  unexcepted handler</td>
</tr>
<tr>

<td> std::exception</td>
<td> function handling exception handler</td>
</tr>
<tr>

<td> std::unexcepted</td>
<td> function handling unexcepted handler</td>
...
<td> termination handler function </td>
</tr>
</table></center>
