	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>  Conditionals</p></b></i></center></h1>
				<hr>
				<br>
				<br>
				<div class="header"><h2>Conditionals</h2></div>

				<div class="header1">
				<br>
				<br>
		
				<h3>Java if and if-else conditional statement.</h3>
				<p>An if statement tells the program that it must carry out a specific piece of code <br>if a condition test evaluates to true.
If an else statement is present another section of code will bee executes if the condition<br> test evaluates to false.<p>
<br>
<br>
<h3>Java if and if-else syntax:</h3>
<br>
<pre>
    ...
    [ 
		else 
		{
			...
			statement;    // Enclosing block is necessary when more 
							than one statement
		}
    ]
</pre>
...
<br>
<p>while will perform a logical test, and if this results in a true condition execute subsequent statements bounded by {} brackets.
<br>do while will first execute statements bounded by {} brackets and than perform a logical test.<br> If the logical test results in a true condition execute the statements bounded by {} brackets again.</p>
<br>
<br>
<h3>Java while and do-while loop syntax::</h3>
<br>
<pre>
	// The while syntax
	while ( condition )
...
<br>
<br>
<p>A for loop is divided into three parts, an initialization part, a conditional part and an increment part
You should sett all initial values in the initialization part of the loop.
A true from the condition part will execute subsequent statements bounded by {} brackets. <br>A false from the condition part will end the loop.
For each loop the increment part will be executed.</p>
<br>
<br>
<h3>Java for loop syntax:</h3>
<br>
<pre>
	...
	// Following each execution of the body, the incrementor 
	expressions are evaluated. </pre> 

<br>
<br>
<h3>Java switch statements.</h3>
<br>
<p>The switch statement can have a number of possible execution paths.
A switch works with the byte, char, short, and int primitive data types.
It works with enum type (java.lang.Enum).
It also works with java.lang.String class and a few special classes that wrap certain primitive types: <br>java.lang.Character, java.lang.Byte, java.lang.Short, and java.lang.Integer.
Must use break to terminate each branch.
Each case will be tested and if none results in a true condition an optional default path with <br>statements will be executed.</p>
<br>
<br>
<h3>Switch syntax:</h3>
<br>
<pre>
	...
	switch ( int expression )
	{
		case int constantExpression :
         statement; break;
		[ case int constantExpression statement; break; ]
		...
		[ default : statement;  ]
	}
 </pre>
