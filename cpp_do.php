...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">	
				...
				<p>In some situation it is necessary to execute body of the loop before testing the condition. Such situations can be handled with the help of do-while loop. do statement evaluates the body of the loop first and at the end, the condition is checked using while statement.</p>
				<br>
	...
	while(condition);
				...
				<center><img src="flowchart-do-statement.png" alt="while-stat"></center> 
	...
	value of a: 19
			...
			<div class="but">
				<a href="cpp_while.php" class="button prev">&laquo;prev</a>
				<a href="cpp_for.php" class="button next">next &raquo;</a>
				</div>
			</div>
		</div>
		<div id="footer">
