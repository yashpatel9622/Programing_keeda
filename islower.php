	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>islower</p></b></i></center></h1>
				<br>
				<hr>
				<br>
			<div class="header"><h2>#include< ctype.h></h2></div>
				<div class="header1">int islower(int ch);</div>
				<br>
	<h2>Check if character is lowercase letter</h2>
				<br>
				<div class="header2">
	Checks if parameter c is a lowercase alphabetic letter.
				<br>
				<br>
	Notice that what is considered a letter may depend on the locale being used;In the default C locale, a lowercase 
	letter is any of:a b c d e f g h I j k l m n o p q r s t u v w x y z.
				<br>
				<br>
	<h3>Parameters</h3>
	c
