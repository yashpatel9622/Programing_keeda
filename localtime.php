	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>localtime</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< time.h></h2></div>
				<div class="header1">struct tm *localtime(const time_t *time);</div>
				<br>
	<h2>Convert time_t to tm as local time</h2>
				<br>
				<div class="header2">
	Uses the time pointed by time to fill a tm structure with the values that represent the corresponding local time.
				<br>
				<br>
	<h3>Parameters</h3>
	time
