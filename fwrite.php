	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>fwrite</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int fwrite(const void *buffer,size_t size,size_t count,FILE *stream);</div>
				<br>
	<h2>Write block of data to stream</h2>
				<br>
				<div class="header2">
	Writes an array of count elements, each one with a size of size bytes, from the block of memory pointed by buffer to the current position in the stream.
				<br>
				<br>
