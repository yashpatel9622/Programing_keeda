...
<body>
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<br>
				<br>
				<h1><center><i><b><p>fgetc</p></b></i></center></h1>
				<br>
				<hr>
				<br>
				<div class="header"><h2>#include< stdio.h></h2></div>
				<div class="header1">int fgetc(FILE *stream);</div>
				<br>
	<h2>Get character from stream</h2>
				<br>
				<div class="header2">
	Returns the character currently pointed by the internal file position indicator of the specified stream. The internal file position indicator is then advanced by one character to point to the next character.
				<br>
				<br>
	fgetc and getc are equivalent, except that the lattewr one may be implementd as a macro.
				<br>
				<br>
	<h3>Parameters</h3>
	stream	
	...
	Pointer to a FILE object that identifies the stream on which the operation is to be performed.
				...
				<br>
	<h3>Return Value</h3>
	The character read is returned as an int value. If the End-of-File is reahed or a reading error happens, the function returns EOF and the corresponding error or eof indicator is set. You can use either ferror or FOF to determine whethe an error happended or the End-of-File was reached.
				</div>
