	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div id="right-section">
				...
				<h4>Description</h4>
				<p>
				 numerics library: Header <cmath> declers aset of function to </br>computer common mathmatical operationand transformation.
				...
				<tr>
				<td><a href="cpp_abs.php"> abs</a></td>
				</tr>
				<tr>
				<td><a href="cpp_acos.php"> acos</a></td>
				</tr>
				<tr>
				<td><a href="cpp_atan.php"> atan</a></td>
				</tr>
				<tr>
				<td><a href="cpp_cbrt.php"> cbrt</a></td>
				</tr>
				<tr>
				<td><a href="cpp_ceil.php"> ceil</a></td>
				</tr>
				<tr>
				<td><a href="cpp_asin.php"> asin</a></td>
				</tr>
				<tr>
